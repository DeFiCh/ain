...
//        consensus.pos.nTargetSpacing = 10 * 60; // 10 minutes
        ...
        consensus.lockAddress = GetScriptForDestination(DecodeDestination("8defichainLockAddressXXXXXXXdRQkSm", *this));
...
//        consensus.pos.nTargetSpacing = 10 * 60; // 10 minutes
        ...
        consensus.lockAddress = GetScriptForDestination(DecodeDestination("7DefichainLockAddressXXXXXXXdMUE5n", *this));
...
public:
    CDevNetParams() {
        ...
        consensus.burnAddress = GetScriptForDestination(DecodeDestination("7DefichainBurnAddressXXXXXXXdMUE5n", *this));
        consensus.retiredBurnAddress = GetScriptForDestination(DecodeDestination("7DefichainDSTBurnAddressXXXXXzS4Hi", *this));
        consensus.lockAddress = GetScriptForDestination(DecodeDestination("7DefichainBurnAddressXXXXXXXdMUE5n", *this));
...
public:
    explicit CRegTestParams() {
        ...
        consensus.lockAddress = GetScriptForDestination(DecodeDestination("mflockZSAM7Gs1hpDeNaMotJXSGA7edosG", *this));
