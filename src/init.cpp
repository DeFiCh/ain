...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-regtest-minttoken-simulate-mainnet", "Follow mainnet codepath for minttoken", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::OPTIONS);
