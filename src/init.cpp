...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-ethmaxresponsesize=<size>", strprintf("Set the maximum response size in MB by the ETH-RPC server (default: %u, testnet: %u, changi: %u, devnet: %u, regtest: %u)", DEFAULT_ETH_MAX_RESPONSE_SIZE_BYTES, DEFAULT_ETH_MAX_RESPONSE_SIZE_BYTES, DEFAULT_ETH_MAX_RESPONSE_SIZE_BYTES, DEFAULT_ETH_MAX_RESPONSE_SIZE_BYTES, DEFAULT_ETH_MAX_RESPONSE_SIZE_BYTES), ArgsManager::ALLOW_ANY | ArgsManager::NETWORK_ONLY, OptionsCategory::RPC);
