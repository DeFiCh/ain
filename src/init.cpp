...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-metachainheight", "Next Network Upgrade fork activation height (regtest only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::CHAINPARAMS);
