...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-healthendpoints", strprintf("Provide API endpoints for health of the current status of the node.(default: %u)", DEFAULT_HEALTH_ENDPOINTS_ENABLE), ArgsManager::ALLOW_ANY, OptionsCategory::RPC);
