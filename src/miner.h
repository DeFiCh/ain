...
private:
    ...
    template<class T>
    void addPackageTxs(int &nPackagesSelected, int &nDescendantsUpdated, int nHeight, CCustomCSView &view, CScopedQueueID &evmQueueId, std::map<uint256, CAmount> &txFees, const bool isEvmEnabledForBlock) EXCLUSIVE_LOCKS_REQUIRED(mempool.cs);
