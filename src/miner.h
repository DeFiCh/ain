...
private:
    ...
    template<class T>
    void addPackageTxs(int &nPackagesSelected, int &nDescendantsUpdated, int nHeight, CCustomCSView &view, std::map<uint256, CAmount> &txFees, const BlockContext &blockContext) EXCLUSIVE_LOCKS_REQUIRED(mempool.cs);
