...
public:
    ...
    std::map<std::string, std::set<uint256>> ethTxsBySender;
...
public:
    ...
    void addUnchecked(const CTxMemPoolEntry& entry, setEntries& setAncestors, bool validFeeEstimate = true, const std::optional<std::string> ethSender = std::nullopt) EXCLUSIVE_LOCKS_REQUIRED(cs, cs_main);
