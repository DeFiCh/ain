...
#ifndef DEFI_RPC_PROTOCOL_H
#define DEFI_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    RPC_LENGTH_ERROR                = -33, //!< Invalid lenght of the passed parameter
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Defi is not connected
