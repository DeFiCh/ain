#ifndef DEFI_DFI_GOVVARIABLES_ICX_TAKERFEE_PER_BTC_H
#define DEFI_DFI_GOVVARIABLES_ICX_TAKERFEE_PER_BTC_H
...
public:
    ...
    Res Erase(CCustomCSView &mnview, uint32_t, const std::vector<std::string> &) override;
...
#endif  // DEFI_DFI_GOVVARIABLES_ICX_TAKERFEE_PER_BTC_H