...
#ifndef DEFI_DFI_GOVVARIABLES_LOAN_LIQUIDATION_PENALTY_H
#define DEFI_DFI_GOVVARIABLES_LOAN_LIQUIDATION_PENALTY_H
...
#endif  // DEFI_DFI_GOVVARIABLES_LOAN_LIQUIDATION_PENALTY_H
