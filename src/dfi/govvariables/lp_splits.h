...
#ifndef DEFI_DFI_GOVVARIABLES_LP_SPLITS_H
#define DEFI_DFI_GOVVARIABLES_LP_SPLITS_H
...
public:
    ...
    static constexpr const char *TypeName() { return "LP_SPLITS"; }
...
#endif  // DEFI_DFI_GOVVARIABLES_LP_SPLITS_H
