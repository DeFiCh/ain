                  ...
                  CCoinsViewCache& view, CCustomCSView& mnview, const CChainParams& chainparams, bool & rewardedAnchors, bool fJustCheck)
{
    ...
    if (isEvmEnabledForBlock) {
        ...
        LogPrintf("[Creating a new CScopedTemplate] from validation\n");
        ...
        LogPrintf("[Creating a new CScopedTemplate] from validation update state in template\n");
        ...
        LogPrintf("[Creating a new CScopedTemplate] from validation update state in template done\n");
    }
...
bool TestBlockValidity(CValidationState& state, const CChainParams& chainparams, const CBlock& block, CBlockIndex* pindexPrev, bool fCheckMerkleRoot)
{
    ...
    if (!::ChainstateActive().ConnectBlock(block, state, &indexDummy, viewNew, mnview, chainparams, dummyRewardedAnchors, true)) return false;
