...
BOOST_AUTO_TEST_CASE(high_precision_interest_rate_tests)
{
    ...
    BOOST_CHECK_EQUAL(GetInterestPerBlockHighPrecisionString(base_uint<128>(2378234398782343987)), "0.000002378234398782343987");
    ...
    BOOST_CHECK_EQUAL(GetInterestPerBlockHighPrecisionString(base_uint<128>(80897539693407360060932882613242451388)), "80897539693407.360060932882613242451388");
    BOOST_CHECK_EQUAL(GetInterestPerBlockHighPrecisionString(base_uint<128>(87741364994776235347880977943597222)), "87741364994.776235347880977943597222");
    BOOST_CHECK_EQUAL(GetInterestPerBlockHighPrecisionString(base_uint<128>(877413626032608048611111111)), "877.413626032608048611111111");
