...
BOOST_AUTO_TEST_CASE(test_CreateEthTx) {
    ...
    const auto reply = evm_try_create_and_sign_tx(result, CreateTransactionContext{chainID, nonce, gasPrice.ToArrayReversed(), gasLimit.ToArrayReversed(), to, value, input, privKey});
