...
sputnikvm_address address_from_str(const char *s);
...
sputnikvm_u256 u256_from_str(const char *s);
...
sputnikvm_h256 h256_from_str(const char *s);
...
#endif // DEFI_RUST_EVM_SPUTNIKVM_H
