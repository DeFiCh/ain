...
void WalletInit::AddWalletOptions() const
{
    ...
    gArgs.AddArg("-blackwallet", strprintf("Run a thread to backup wallet periodically (default: %u)", DEFAULT_BACKUPWALLET), ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::WALLET_DEBUG_TEST);
