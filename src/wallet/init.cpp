...
void WalletInit::AddWalletOptions() const
{
    ...
    gArgs.AddArg("-backupwallet=<m>", strprintf("Backup wallet database every <m> minutes (default: %d), to disable <= 0", DEFAULT_WALLET_BACKUP_PERIOD), ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
