...
#ifndef BITCOIN_MASTERNODES_GOVVARIABLES_LOAN_SPLITS_H
#define BITCOIN_MASTERNODES_GOVVARIABLES_LOAN_SPLITS_H
...
#endif // BITCOIN_MASTERNODES_GOVVARIABLES_LOAN_SPLITS_H
