#ifndef BITCOIN_MASTERNODES_GOVVARIABLES_ICX_TAKERFEE_PER_BTC_H
#define BITCOIN_MASTERNODES_GOVVARIABLES_ICX_TAKERFEE_PER_BTC_H
...
#endif // BITCOIN_MASTERNODES_GOVVARIABLES_ICX_TAKERFEE_PER_BTC_H