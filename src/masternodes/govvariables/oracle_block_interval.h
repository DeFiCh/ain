...
#ifndef BITCOIN_MASTERNODES_GOVVARIABLES_ORACLE_BLOCK_INTERVAL_H
#define BITCOIN_MASTERNODES_GOVVARIABLES_ORACLE_BLOCK_INTERVAL_H
...
#endif // BITCOIN_MASTERNODES_GOVVARIABLES_ORACLE_BLOCK_INTERVAL_H
