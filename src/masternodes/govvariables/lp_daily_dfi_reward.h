...
#ifndef BITCOIN_MASTERNODES_GOVVARIABLES_LP_DAILY_DFI_REWARD_H
#define BITCOIN_MASTERNODES_GOVVARIABLES_LP_DAILY_DFI_REWARD_H
...
#endif // BITCOIN_MASTERNODES_GOVVARIABLES_LP_DAILY_DFI_REWARD_H
