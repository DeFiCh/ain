...
#ifndef BITCOIN_MASTERNODES_GOVVARIABLES_LP_SPLITS_H
#define BITCOIN_MASTERNODES_GOVVARIABLES_LP_SPLITS_H
...
#endif // BITCOIN_MASTERNODES_GOVVARIABLES_LP_SPLITS_H
