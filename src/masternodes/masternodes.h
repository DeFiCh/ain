...
public:
    ...
    ResVal<CAmount> GetAmountInCurrency(CAmount amount, CTokenCurrencyPair priceFeedId, uint32_t height, bool useNextPrice = false, bool requireLivePrice = true);
    ...
    ResVal<CAmount> GetValidatedIntervalPrice(CTokenCurrencyPair priceFeedId, bool useNextPrice, bool requireLivePrice, uint32_t height);
