...
#include <config/defi-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatDefiURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + DefiUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatDefiURI(info));
}
