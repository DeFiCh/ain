    ...
    mapper(nullptr)
{
    ...
    ui->defiAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->defiAtStartup);
    ...
    ui->defiAtStartup->setToolTip(ui->defiAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->defiAtStartup->setText(ui->defiAtStartup->text().arg(PACKAGE_NAME));

    ui->openDefiConfButton->setToolTip(ui->openDefiConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new DefiUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->defiAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openDefiConfButton_clicked()
{
