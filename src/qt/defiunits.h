...
#ifndef DEFI_QT_DEFIUNITS_H
#define DEFI_QT_DEFIUNITS_H
...
/** Defi unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DefiUnits: public QAbstractListModel
{
    Q_OBJECT
...
typedef DefiUnits::Unit DefiUnit;

#endif // DEFI_QT_DEFIUNITS_H
