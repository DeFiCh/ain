    ...
    platformStyle(_platformStyle)
{
    ...
    // normal defi address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying defi address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &DefiAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
