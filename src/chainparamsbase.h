...
public:
    ...
    CBaseChainParams(const std::string& data_dir, int rpc_port, int grpc_port, int ethrpc_port, int ws_port) : nRPCPort(rpc_port), nGRPCPort(grpc_port), nETHRPCPort(ethrpc_port), nWSPort(ws_port), strDataDir(data_dir) {}
