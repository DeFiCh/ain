...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    "chainparams -> dfi/customtx -> chainparams"
    "chainparams -> dfi/customtx -> dfi/accounts -> dfi/errors -> dfi/vault -> chainparams"
    ...
    "dfi/consensus/xvm -> dfi/masternodes -> dfi/evm -> dfi/consensus/xvm"
    ...
    "dfi/govvariables/attributes -> dfi/govvariables/attributetypes -> dfi/loan -> dfi/govvariables/attributes"
