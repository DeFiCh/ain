...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "chainparams -> masternodes/mn_checks -> rpc/util -> node/transaction -> net -> chainparams"
    "chainparams -> masternodes/mn_checks -> rpc/util -> node/transaction -> net_processing -> chainparams"
    "addrdb -> chainparams -> masternodes/mn_checks -> rpc/util -> node/transaction -> net -> addrdb"
    "blockencodings -> chainparams -> masternodes/mn_checks -> rpc/util -> node/transaction -> net_processing -> blockencodings"
    "addrdb -> chainparams -> masternodes/mn_checks -> rpc/util -> node/transaction -> net -> banman -> addrdb"
