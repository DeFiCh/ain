...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "chain -> chainparams -> masternodes/mn_checks -> validation -> masternodes/vaulthistory -> chain"
    ...
    "chainparams -> masternodes/mn_checks -> validation -> masternodes/vaulthistory -> masternodes/vault -> chainparams"
    ...
    "masternodes/masternodes -> validation -> masternodes/vaulthistory -> masternodes/masternodes"
