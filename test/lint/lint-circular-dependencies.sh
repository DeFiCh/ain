...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "chainparams -> dfi/mn_checks -> dfi/consensus/accounts -> dfi/consensus/txvisitor -> chainparams"
    "chainparams -> dfi/mn_checks -> dfi/consensus/smartcontracts -> chainparams"
    ...
    "consensus/tx_verify -> dfi/masternodes -> validation -> consensus/tx_verify"
    "consensus/tx_verify -> dfi/mn_checks -> txmempool -> consensus/tx_verify"
    "ffi/ffiexports -> dfi/mn_rpc -> wallet/rpcwallet -> init -> ffi/ffiexports"
    "index/txindex -> validation -> index/txindex"
    "init -> dfi/govvariables/attributes -> dfi/mn_rpc -> wallet/rpcwallet -> init"
    ...
    "dfi/consensus/accounts -> dfi/consensus/txvisitor -> dfi/govvariables/attributes -> dfi/mn_checks -> dfi/consensus/accounts"
    "dfi/consensus/governance -> dfi/govvariables/attributes -> dfi/mn_checks -> dfi/consensus/governance"
    "dfi/consensus/icxorders -> dfi/mn_checks -> dfi/consensus/icxorders"
    "dfi/consensus/loans -> dfi/mn_checks -> dfi/consensus/loans"
    "dfi/consensus/masternodes -> dfi/govvariables/attributes -> dfi/mn_checks -> dfi/consensus/masternodes"
    "dfi/consensus/oracles -> dfi/masternodes -> dfi/mn_checks -> dfi/consensus/oracles"
    "dfi/consensus/poolpairs -> dfi/mn_checks -> dfi/consensus/poolpairs"
    "dfi/consensus/proposals -> dfi/govvariables/attributes -> dfi/mn_checks -> dfi/consensus/proposals"
    "dfi/consensus/smartcontracts -> dfi/govvariables/attributes -> dfi/mn_checks -> dfi/consensus/smartcontracts"
