...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "chain -> dfi/govvariables/attributes -> dfi/mn_rpc -> wallet/rpcwallet -> init -> chain"
    "chain -> dfi/govvariables/attributes -> dfi/mn_rpc -> wallet/rpcwallet -> init -> index/blockfilterindex -> chain"
    "chain -> dfi/govvariables/attributes -> dfi/mn_rpc -> wallet/rpcwallet -> init -> miner -> consensus/tx_verify -> chain"
    "chain -> dfi/govvariables/attributes -> dfi/mn_rpc -> wallet/rpcwallet -> init -> miner -> chain"
    "chain -> dfi/govvariables/attributes -> dfi/mn_rpc -> wallet/rpcwallet -> init -> miner -> pos -> chain"
    "chain -> dfi/govvariables/attributes -> dfi/mn_rpc -> wallet/rpcwallet -> init -> rpc/blockchain -> chain"
    "chain -> dfi/govvariables/attributes -> dfi/mn_rpc -> wallet/rpcwallet -> init -> zmq/zmqnotificationinterface -> zmq/zmqpublishnotifier -> chain"
    "chain -> dfi/govvariables/attributes -> dfi/validation -> chain"
    "chain -> dfi/govvariables/attributes -> validation -> chain"
    "chain -> dfi/govvariables/attributes -> validation -> txdb -> chain"
    "chain -> dfi/govvariables/attributes -> validation -> versionbits -> chain"
    "chain -> dfi/masternodes -> dfi/vaulthistory -> chain"
    "chain -> dfi/masternodes -> wallet/wallet -> chain"
    ...
    "dfi/govvariables/attributes -> dfi/masternodes -> net_processing -> dfi/govvariables/attributes"
    ...
    "dfi/govvariables/attributes -> dfi/mn_rpc -> wallet/rpcwallet -> init -> miner -> pos -> dfi/govvariables/attributes"
    "dfi/govvariables/attributes -> dfi/oracles -> dfi/govvariables/attributes"
    ...
    "dfi/masternodes -> dfi/poolpairs -> dfi/masternodes"
    ...
    "dfi/mn_rpc -> rpc/resultcache -> dfi/mn_rpc"
