...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "masternodes/accountshistory -> masternodes/mn_checks -> masternodes/accountshistory"
    ...
    "masternodes/historywriter -> masternodes/masternodes -> masternodes/mn_checks -> masternodes/historywriter"
