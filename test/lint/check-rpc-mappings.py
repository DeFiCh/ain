...
SOURCES = [
    ...
    "src/dfi/rpc_evm.cpp",
    "src/dfi/rpc_proposals.cpp",
    "src/dfi/rpc_icxorderbook.cpp",
    "src/dfi/rpc_loan.cpp",
    "src/dfi/rpc_masternodes.cpp",
    "src/dfi/rpc_oracles.cpp",
    "src/dfi/rpc_poolpair.cpp",
    "src/dfi/rpc_tokens.cpp",
    "src/dfi/rpc_vault.cpp",
    "src/spv/spv_rpc.cpp",
]
