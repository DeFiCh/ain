...
class AccountsAndUTXOsTest(DefiTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(self.nodes[0].getaccount(accountGold, {}, True)[idGold],
                     self.nodes[1].getaccount(accountGold, {}, True)[idGold])
        assert_equal(self.nodes[0].getaccount(toGold, {}, True)[idGold],
        ...
        assert_equal(self.nodes[0].getaccount(accountSilver, {}, True)[idSilver],
                     self.nodes[1].getaccount(accountSilver, {}, True)[idSilver])
        assert_equal(self.nodes[0].getaccount(toSilver, {}, True)[idSilver],
        ...
        # ========================
        assert_raises_rpc_error(-4, "Unexpected token type set for recipient. Only native DFI token type expected.",
