...
class PoolPairTest(DefiTestFramework):
    ...
    def create_tokens(self):
        ...
        self.nodes[0].generate(1)
        self.symbol_key_GOLD = "GOLD#" + str(get_id_token(self.nodes, self.symbolGOLD))
        self.symbol_key_SILVER = "SILVER#" + str(get_id_token(self.nodes, self.symbolSILVER))
        self.symbol_key_DOGE = "DOGE#" + str(get_id_token(self.nodes, self.symbolDOGE))
