...
class PSBTTest(DefiTestFramework):
    ...
    def test_utxo_conversion(self):
        ...
        raw = online_node.createrawtransaction(
    ...
    def run_test(self):
        ...
        p2wsh = self.nodes[1].addmultisigaddress(
            2, [pubkey0, pubkey1, pubkey2], "", "bech32"
        )["address"]
        p2sh_p2wsh = self.nodes[1].addmultisigaddress(
        ...
        test_psbt_input_keys(
            decoded["inputs"][2], ["witness_utxo", "bip32_derivs", "redeem_script"]
        )
