...
class ConsortiumTest(DefiTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [
            [
                ...
                "-fortcanningcrunchheight=50",
                "-fortcanningspringheight=50",
                "-fortcanninggreatworldheight=250",
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(
            -32600,
            "You are not a foundation member or token owner and cannot mint this token",
            self.nodes[2].minttokens,
            ["1@" + symbolBTC],
        )
        assert_raises_rpc_error(
            -32600,
        ...
        assert_raises_rpc_error(
            -32600,
            "Mint limit higher than global mint limit",
            self.nodes[0].setgov,
            {
                "ATTRIBUTES": {
                    "v0/consortium/"
        ...
        assert_raises_rpc_error(
            -32600,
            "Daily mint limit higher than daily global mint limit",
            self.nodes[0].setgov,
            {
                "ATTRIBUTES": {
                    "v0/consortium/"
        ...
        assert_equal(
            attribs["v0/consortium/" + idBTC + "/members"],
            {
                "01": {
                    "name": "account2BTC",
                    "ownerAddress": account2,
                    ...
                    "mintLimitDaily": Decimal("10.00000000"),
                    "status": 0,
                },
                "02": {
                    "name": "account3BTC",
                    "ownerAddress": account3,
                    "backingId": "6c67fe93cad3d6a4982469a9b6708cdde2364f183d3698d3745f86eeb8ba99d5",
                    "mintLimit": Decimal("4.00000000"),
                    "mintLimitDaily": Decimal("4.00000000"),
                    "status": 0,
                },
            },
        )
        ...
        attribs = self.nodes[2].getgov("ATTRIBUTES")["ATTRIBUTES"]
        assert_equal(
            attribs["v0/live/economy/consortium/1/minted"], Decimal("1.00000000")
        )
        assert_equal(
            attribs["v0/live/economy/consortium/1/burnt"], Decimal("0.00000000")
        )
        assert_equal(
            attribs["v0/live/economy/consortium/1/supply"], Decimal("1.00000000")
        )
        ...
        assert_equal(
            attribs["v0/consortium/" + idDOGE + "/members"],
            {
                "01": {
                    "name": "account2DOGE",
                    "ownerAddress": account2,
                    "backingId": "ebf634ef7143bc5466995a385b842649b2037ea89d04d469bfa5ec29daf7d1cf",
                    "mintLimit": Decimal("5.00000000"),
                    "mintLimitDaily": Decimal("5.00000000"),
                    "status": 0,
                },
                "02": {
                    "name": "account1DOGE",
        ...
        assert_equal(
            self.nodes[2].getaccount(account2),
            ["1.00000000@" + symbolBTC, "2.00000000@" + symbolDOGE],
        )
        ...
        assert_equal(
            attribs["v0/live/economy/consortium/2/minted"], Decimal("2.00000000")
        )
        assert_equal(
            attribs["v0/live/economy/consortium/2/burnt"], Decimal("0.00000000")
        )
        assert_equal(
            attribs["v0/live/economy/consortium/2/supply"], Decimal("2.00000000")
        )
        assert_equal(
            attribs["v0/live/economy/consortium_members/1/01/minted"],
            Decimal("1.00000000"),
        )
        assert_equal(
            attribs["v0/live/economy/consortium_members/1/01/daily_minted"],
            "144/1.00000000",
        )
        assert_equal(
            attribs["v0/live/economy/consortium_members/1/01/burnt"],
            Decimal("0.00000000"),
        )
        assert_equal(
            attribs["v0/live/economy/consortium_members/1/01/supply"],
            Decimal("1.00000000"),
        )
        assert_equal(
            attribs["v0/live/economy/consortium_members/2/01/minted"],
            Decimal("2.00000000"),
        )
        assert_equal(
            attribs["v0/live/economy/consortium_members/2/01/daily_minted"],
            "144/2.00000000",
        )
        assert_equal(
            attribs["v0/live/economy/consortium_members/2/01/burnt"],
            Decimal("0.00000000"),
        )
        assert_equal(
            attribs["v0/live/economy/consortium_members/2/01/supply"],
            Decimal("2.00000000"),
        )

        assert_raises_rpc_error(
            -32600,
            "You will exceed your maximum mint limit for "
            + symbolDOGE
            + " token by minting this amount!",
            self.nodes[2].minttokens,
            ["3.00000001@" + symbolDOGE],
        )
        assert_raises_rpc_error(
            -8,
            'No valid addresses could be found, use the "from" argument to set address to burn from',
            self.nodes[0].burntokens,
            {"amounts": "1.00000000@" + symbolBTC},
        )
        ...
        assert_equal(
            self.nodes[2].getaccount(account2),
            ["1.00000000@" + symbolBTC, "1.00000000@" + symbolDOGE],
        )
        ...
        assert_equal(
            attribs["v0/live/economy/consortium/2/burnt"], Decimal("1.00000000")
        )
        assert_equal(
            attribs["v0/live/economy/consortium/2/supply"], Decimal("1.00000000")
        )
        assert_equal(
            attribs["v0/live/economy/consortium_members/1/01/minted"],
            Decimal("1.00000000"),
        ...
        self.nodes[0].burntokens(
            {"amounts": "0.5@" + symbolDOGE, "from": account0, "context": account2}
        )
        ...
        assert_equal(
            attribs["v0/live/economy/consortium/2/burnt"], Decimal("1.50000000")
        )
        assert_equal(
            attribs["v0/live/economy/consortium/2/supply"], Decimal("0.50000000")
        )
        assert_equal(
            attribs["v0/live/economy/consortium_members/1/01/minted"],
            Decimal("1.00000000"),
        ...
        assert_equal(
            self.nodes[0].getburninfo(),
            {
                ...
                "amount": Decimal("0E-8"),
                "tokens": ["2.00000000@BTC", "0.50000000@DOGE"],
                "consortiumtokens": ["1.50000000@DOGE"],
                "feeburn": Decimal("2.00000000"),
                "auctionburn": Decimal("0E-8"),
                "paybackburn": [],
                "dexfeetokens": [],
                "dfipaybackfee": Decimal("0E-8"),
                "dfipaybacktokens": [],
                "paybackfees": [],
                "paybacktokens": [],
                "emissionburn": Decimal("4923.76500000"),
                "dfip2203": [],
                "dfip2206f": [],
            },
        )
        ...
        assert_raises_rpc_error(
            -32600,
            "Cannot mint token, not an active member of consortium for DOGE!",
            self.nodes[2].minttokens,
            ["1@" + symbolDOGE],
        )
        ...
        attribs = self.nodes[0].getgov("ATTRIBUTES")["ATTRIBUTES"]
        assert_equal(
            attribs["v0/live/economy/consortium/1/minted"], Decimal("9.00000000")
        )
        assert_equal(
            attribs["v0/live/economy/consortium/1/burnt"], Decimal("6.00000000")
        )
        assert_equal(
            attribs["v0/live/economy/consortium/1/supply"], Decimal("3.00000000")
        )
        assert_equal(
            attribs["v0/live/economy/consortium/2/minted"], Decimal("2.00000000")
        )
        ...
        assert_equal(
            attribs["v0/live/economy/consortium_members/1/02/minted"],
            Decimal("2.00000000"),
        )
        assert_equal(
            attribs["v0/live/economy/consortium_members/1/02/daily_minted"],
            "144/2.00000000",
        )
        assert_equal(
            attribs["v0/live/economy/consortium_members/1/02/burnt"],
            Decimal("0.00000000"),
        )
        assert_equal(
            attribs["v0/live/economy/consortium_members/1/02/supply"],
            Decimal("2.00000000"),
        )
        ...
        assert_raises_rpc_error(
            ...
            + " token by minting this amount!",
            self.nodes[3].minttokens,
            ["2.00000001@" + symbolBTC],
        )
        assert_raises_rpc_error(
            -32600,
            "You will exceed global maximum consortium mint limit for "
            + symbolBTC
            + " token by minting this amount!",
            self.nodes[3].minttokens,
            ["1.00000001@" + symbolBTC],
        )
        ...
        self.nodes[0].setgov(
            {"ATTRIBUTES": {"v0/consortium/" + idBTC + "/mint_limit": "20"}}
        )
        self.nodes[0].generate(1)
        self.sync_blocks()
        ...
        assert_raises_rpc_error(
            -32600,
            "You will exceed global daily maximum consortium mint limit for "
            + symbolBTC
            + " token by minting this amount.",
            self.nodes[3].minttokens,
            ["2@" + symbolBTC],
        ...
        self.nodes[0].setgov(
            {"ATTRIBUTES": {"v0/consortium/" + idBTC + "/mint_limit_daily": "12"}}
        )
        self.nodes[0].generate(1)
        self.sync_blocks()
        ...
        assert_raises_rpc_error(
            -32600,
            "You will exceed your daily mint limit for "
            + symbolBTC
            + " token by minting this amount",
            self.nodes[3].minttokens,
            ["2@" + symbolBTC],
        ...
        attribs = self.nodes[0].getgov("ATTRIBUTES")["ATTRIBUTES"]
        assert_equal(
            attribs["v0/live/economy/consortium/1/minted"], Decimal("13.00000000")
        )
        assert_equal(
            attribs["v0/live/economy/consortium/1/burnt"], Decimal("6.00000000")
        )
        assert_equal(
            attribs["v0/live/economy/consortium/1/supply"], Decimal("7.00000000")
        )
        assert_equal(
            attribs["v0/live/economy/consortium/2/minted"], Decimal("2.00000000")
        )
        ...
        self.nodes[1].burntokens(
            {"amounts": "0.1@" + symbolBTC, "from": account1, "context": account2}
        )
        self.nodes[1].generate(1)
        self.sync_blocks()
        ...
        assert_equal(
            attribs["v0/live/economy/consortium/1/burnt"], Decimal("6.10000000")
        )
        assert_equal(
            attribs["v0/live/economy/consortium/1/supply"], Decimal("6.90000000")
        )
        assert_equal(
            attribs["v0/live/economy/consortium/2/minted"], Decimal("2.00000000")
        )
        ...
        assert_equal(
            self.nodes[0].getburninfo(),
            {
                "address": "mfburnZSAM7Gs1hpDeNaMotJXSGA7edosG",
                "amount": Decimal("0E-8"),
                "tokens": ["2.10000000@BTC", "0.50000000@DOGE"],
                "consortiumtokens": ["6.10000000@BTC", "1.50000000@DOGE"],
                "feeburn": Decimal("2.00000000"),
                "auctionburn": Decimal("0E-8"),
                "paybackburn": [],
                "dexfeetokens": [],
                ...
                "paybackfees": [],
                "paybacktokens": [],
                "emissionburn": Decimal("5386.81500000"),
                "dfip2203": [],
                "dfip2206f": [],
            },
        )
        ...
        assert_raises_rpc_error(
            -32600,
            "ATTRIBUTES: Cannot be set before GrandCentralEpilogueHeight",
            self.nodes[0].setgov,
        ...
        assert_raises_rpc_error(
            -32600,
            "Mint tokens to address is not enabled",
            self.nodes[0].minttokens,
            {"amounts": ["2@" + symbolBTC], "to": newAddress},
        )
        ...
        self.nodes[0].minttokens(
            {
                "amounts": ["2@" + symbolBTC, "2@" + symbolDOGE, "2@" + symbolLTC],
                "to": newAddress,
            }
        )
        self.nodes[0].generate(1)
        assert_equal(
            self.nodes[0].getaccount(newAddress),
            [
                "2.00000000@" + symbolBTC,
                "2.00000000@" + symbolDOGE,
                "2.00000000@" + symbolLTC,
            ],
        )

        assert_raises_rpc_error(
            -5,
            "recipient (NOTANADDRESS) does not refer to any valid address",
            self.nodes[0].minttokens,
            {"amounts": ["2@" + symbolBTC], "to": "NOTANADDRESS"},
        )
