...
class GovsetTest (DefiTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Unrecognised key argument provided, valid keys are: daily_mint_limit, members, mint_limit,", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/consortium/5/unrecognised':'true'}})
        ...
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before GrandCentral", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/params/feature/consortium_enabled':'true'}})
        ...
        self.nodes[0].setgov({"ATTRIBUTES":{'v0/consortium/4/mint_limit' : '10', 'v0/consortium/4/daily_mint_limit' : '1'}})
        self.nodes[0].generate(1)
