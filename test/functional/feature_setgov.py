...
class GovsetTest(DefiTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [
            [
                ...
                "-bayfrontheight=50",
                "-eunosheight=200",
                "-fortcanningheight=400",
                "-fortcanninghillheight=1110",
                "-fortcanningroadheight=1150",
    ...
    def run_test(self):
        ...
        try:
            self.nodes[0].setgov({"LP_SPLITS": {"0": 0.5, "1": 0.4, "2": 0.2}})
        except JSONRPCException as e:
            errorString = e.error["message"]
        ...
        try:
            self.nodes[0].setgov({"LP_SPLITS": {"1": 0.5, "2": 0.4, "3": 0.2}})
        except JSONRPCException as e:
            errorString = e.error["message"]
        assert "total" in errorString

        self.nodes[0].setgov({"LP_SPLITS": {"1": 0.5, "2": 0.4, "3": 0.1}})
        ...
        assert g1 == {
            "LP_SPLITS": {
                "1": Decimal("0.50000000"),
                "2": Decimal("0.40000000"),
                "3": Decimal("0.10000000"),
            }
        }
        ...
        assert (
            pool1["rewardPct"] == Decimal("0.50000000")
        ...
        # test set multuple:
        self.nodes[0].setgov({"LP_SPLITS": {"1": 1}, "LP_DAILY_DFI_REWARD": 45})
        self.nodes[0].generate(1)
        ...
        # Check new subsidy
        assert_equal(
            self.nodes[0].getgov("LP_DAILY_DFI_REWARD")["LP_DAILY_DFI_REWARD"],
            Decimal("14843.90592000"),
        )  # 144 blocks a day times 103.08268000
        ...
        assert_equal(
            self.nodes[0].getgov("LP_DAILY_DFI_REWARD")["LP_DAILY_DFI_REWARD"],
            Decimal("14597.79395904"),
        )  # 144 blocks a day times 101.37356916
        ...
        assert_equal(
            self.nodes[0].getgov("LP_DAILY_LOAN_TOKEN_REWARD")[
        ...
        try:
            self.nodes[0].setgov(
                {"LP_LOAN_TOKEN_SPLITS": {"1": 0.1, "2": 0.2, "3": 0.7}}
            )
        except JSONRPCException as e:
            errorString = e.error["message"]
        assert "Cannot be set before FortCanning" in errorString
        ...
        try:
            self.nodes[0].setgovheight(
                {"ORACLE_DEVIATION": Decimal("0.01000000")},
        ...
        try:
            self.nodes[0].setgovheight(
                {"ORACLE_DEVIATION": Decimal("0.00100000")},
                self.nodes[0].getblockcount() + 10,
            )
        except JSONRPCException as e:
            errorString = e.error["message"]
        ...
        )  # 144 blocks a day times 98.30647100
        ...
        assert_equal(
            ...
            Decimal("13921.42315824"),
        )  # 144 blocks a day times 96.67654971
        ...
        self.nodes[0].generate(1)
        assert_equal(
            self.nodes[0].getgov("ORACLE_DEVIATION")["ORACLE_DEVIATION"],
            Decimal("0.01000000"),
        )
        ...
        self.nodes[0].generate(1)
        assert_equal(
            self.nodes[0].getgov("LOAN_LIQUIDATION_PENALTY")[
        ...
        self.nodes[0].setgovheight(
            {"ORACLE_DEVIATION": Decimal("0.02000000")},
            self.nodes[0].getblockcount() + 10,
        )
        self.nodes[0].generate(1)
        assert_equal(
        ...
        self.nodes[0].setgovheight(
            {"LP_SPLITS": {"1": 0.1, "2": 0.2, "3": 0.7}}, activate
        )
        self.nodes[0].generate(1)
        self.nodes[0].setgovheight(
            {"LP_SPLITS": {"1": 0.2, "2": 0.2, "3": 0.6}}, activate
        )
        self.nodes[0].generate(1)
        self.nodes[0].setgovheight(
            {"LP_SPLITS": {"1": 0.3, "2": 0.2, "3": 0.5}}, activate
        )
        self.nodes[0].generate(1)
        self.nodes[0].setgovheight(
            {"LP_SPLITS": {"1": 0.4, "2": 0.2, "3": 0.4}}, activate
        )
        self.nodes[0].generate(7)
        assert_equal(
            self.nodes[0].getgov("LP_SPLITS")["LP_SPLITS"],
            {
                "1": Decimal("0.40000000"),
                "2": Decimal("0.20000000"),
                "3": Decimal("0.40000000"),
            },
        )
        ...
        activate = self.nodes[0].getblockcount() + 10
        self.nodes[0].setgovheight(
            {"LP_SPLITS": {"1": 0.5, "2": 0.2, "3": 0.3}}, activate
        )
        self.nodes[0].setgovheight(
            {"ORACLE_DEVIATION": Decimal("0.03000000")}, activate
        )
        self.nodes[0].generate(1)
        self.nodes[0].setgovheight(
            {"ORACLE_DEVIATION": Decimal("0.04000000")}, activate
        )
        self.nodes[0].generate(1)
        self.nodes[0].setgovheight(
            {"LP_SPLITS": {"1": 0.6, "2": 0.2, "3": 0.2}}, activate
        )
        self.nodes[0].generate(1)
        self.nodes[0].setgovheight(
            {"ORACLE_DEVIATION": Decimal("0.05000000")}, activate
        )
        self.nodes[0].generate(1)
        self.nodes[0].setgovheight(
            {"LP_SPLITS": {"1": 0.7, "2": 0.2, "3": 0.1}}, activate
        )
        self.nodes[0].generate(6)
        assert_equal(
            self.nodes[0].getgov("LP_SPLITS")["LP_SPLITS"],
            {
                "1": Decimal("0.70000000"),
                "2": Decimal("0.20000000"),
                "3": Decimal("0.10000000"),
            },
        )
        ...
        try:
            self.nodes[0].setgov(
                {"LP_LOAN_TOKEN_SPLITS": {"1": 0.1, "2": 0.2, "3": 0.3}}
            )
        except JSONRPCException as e:
            errorString = e.error["message"]
        ...
        self.nodes[0].generate(1)
        assert_equal(
            self.nodes[0].getgov("LP_LOAN_TOKEN_SPLITS")["LP_LOAN_TOKEN_SPLITS"],
            {
                "1": Decimal("0.10000000"),
                "2": Decimal("0.20000000"),
                "3": Decimal("0.70000000"),
            },
        )

        # Check reward set on pool pairs
        assert_equal(
            self.nodes[0].getpoolpair("1", True)["1"]["rewardLoanPct"],
            Decimal("0.10000000"),
        )
        assert_equal(
            self.nodes[0].getpoolpair("2", True)["2"]["rewardLoanPct"],
            Decimal("0.20000000"),
        )
        assert_equal(
            self.nodes[0].getpoolpair("3", True)["3"]["rewardLoanPct"],
            Decimal("0.70000000"),
        )
        ...
        assert_equal(
            result[1][0]["LP_DAILY_LOAN_TOKEN_REWARD"], Decimal("13921.42315824")
        )
        assert_equal(
            result[2][0]["LP_LOAN_TOKEN_SPLITS"],
            {
                "1": Decimal("0.10000000"),
                "2": Decimal("0.20000000"),
                "3": Decimal("0.70000000"),
        ...
        self.nodes[0].setgovheight(
            {"ORACLE_DEVIATION": Decimal("0.06000000")}, activate
        )
        self.nodes[0].setgovheight(
            {"ORACLE_DEVIATION": Decimal("0.07000000")}, activate + 1
        )
        self.nodes[0].setgovheight(
            {"ICX_TAKERFEE_PER_BTC": Decimal("0.00100000")}, activate
        )
        self.nodes[0].setgovheight(
            {"ICX_TAKERFEE_PER_BTC": Decimal("0.00200000")}, activate + 1
        )
        self.nodes[0].generate(1)
        ...
        self.nodes[0].generate(1)
        interval = self.nodes[0].getgov("ORACLE_BLOCK_INTERVAL")[
            "ORACLE_BLOCK_INTERVAL"
        ]
        assert_equal(
            self.nodes[0].getgov("ORACLE_BLOCK_INTERVAL")["ORACLE_BLOCK_INTERVAL"], 20
        )
        ...
        assert_raises_rpc_error(
            -32600,
            "ATTRIBUTES: Cannot be set before FortCanningHill",
            self.nodes[0].setgov,
        ...
        assert_raises_rpc_error(
            -5,
            "Object of values expected",
            self.nodes[0].setgov,
            {"ATTRIBUTES": "error"},
        )
        assert_raises_rpc_error(
            -5, "Object of values expected", self.nodes[0].setgov, {"ATTRIBUTES": "{}"}
        )
        assert_raises_rpc_error(
            -5, "Empty version", self.nodes[0].setgov, {"ATTRIBUTES": {"": "true"}}
        )
        assert_raises_rpc_error(
            -5,
            "Unsupported version",
        ...
        assert_raises_rpc_error(
            ...
            self.nodes[0].setgov,
            {"ATTRIBUTES": {"v0/token/payback_dfi": "true"}},
        )
        assert_raises_rpc_error(
            -5,
        ...
        assert_raises_rpc_error(
            -32600,
            "ATTRIBUTES: No such loan token (5)",
            self.nodes[0].setgov,
            {"ATTRIBUTES": {"v0/token/5/payback_dfi": "true"}},
        )
        assert_raises_rpc_error(
        ...
        assert_raises_rpc_error(
            -32600,
            "ATTRIBUTES: Cannot be set before FortCanningRoad",
            self.nodes[0].setgov,
        ...
        appoint_oracle_tx = self.nodes[0].appointoracle(
            oracle_address,
            [
        ...
        oracle_prices = [
            {"currency": "USD", "tokenAmount": "100.00000000@DFI"},
        ...
        self.nodes[0].setcollateraltoken(
            {"token": "DUSD", "factor": 1, "fixedIntervalPriceId": "DFI/USD"}
        )
        self.nodes[0].generate(1)
        ...
        assert_equal(
            ...
            {
                "v0/token/5/payback_dfi": "true",
                "v0/token/5/payback_dfi_fee_pct": "0.05",
            },
        )
        assert_equal(
            self.nodes[0].listgovs()[8][0]["ATTRIBUTES"],
            {
                "v0/token/5/payback_dfi": "true",
                "v0/token/5/payback_dfi_fee_pct": "0.05",
            },
        ...
        self.nodes[0].setgov(
            {
                "ATTRIBUTES": {
                    "v0/token/5/payback_dfi": "false",
                    "v0/token/5/payback_dfi_fee_pct": "0.02378",
                }
            }
        )
        self.nodes[0].generate(1)
        ...
        assert_equal(
            self.nodes[0].listgovs()[8][1][str(activate)],
            {
                "v0/token/5/payback_dfi": "true",
                "v0/token/5/payback_dfi_fee_pct": "0.01",
            },
        ...
        self.nodes[0].setgov(
            {
                "ATTRIBUTES": {
                    "v0/token/5/loan_payback/0": "true",
                    "v0/token/5/loan_payback_fee_pct/0": "0.33",
                }
            }
        )
        self.nodes[0].generate(1)
        ...
        assert_raises_rpc_error(
            -5,
            "Unsupported type for this DFIP",
            self.nodes[0].setgov,
        ...
        assert_equal(
            result,
            [
                [{"ICX_TAKERFEE_PER_BTC": Decimal("0.00200000")}],
                [{"LP_DAILY_LOAN_TOKEN_REWARD": Decimal("13020.86331792")}],
                [
                    {
                ...
                [{"LOAN_LIQUIDATION_PENALTY": Decimal("0.01000000")}],
                [
                    {
                        "LP_SPLITS": {
                            "1": Decimal("0.70000000"),
                ...
                [{"ORACLE_BLOCK_INTERVAL": 30}],
                [{"ORACLE_DEVIATION": Decimal("0.07000000")}],
                [],
            ],
        )
        ...
        assert_raises_rpc_error(
            -32600,
            "ATTRIBUTES: Cannot be set before FortCanningCrunch",
            self.nodes[0].setgov,
        ...
        self.nodes[0].setgov(
            {
                "ATTRIBUTES": {
                    f"v0/token/4/fixed_interval_price_id": "TSLA/USD",
        ...
        # Check auto lock
        assert_equal(
            self.nodes[0].listgovs()[8][1]["3928"], {"v0/locks/token/4": "true"}
        )
        ...
        self.nodes[0].generate(1)
        assert_equal(
            self.nodes[0].listgovs()[8][1]["3928"], {"v0/locks/token/4": "false"}
        )
        ...
        self.nodes[0].setgovheight(
            {"ATTRIBUTES": {"v0/oracles/splits/4001": "5/10"}}, activation_height
        )
        self.nodes[0].generate(1)
        ...
        activation_height = self.nodes[0].getblockcount() + 5
        self.nodes[0].setgovheight(
            {"ATTRIBUTES": {"v0/locks/token/4": "true"}}, activation_height
        )
        self.nodes[0].generate(1)
        ...
        activation_height = self.nodes[0].getblockcount() + 5
        self.nodes[0].setgovheight(
            {"ATTRIBUTES": {f"v0/oracles/splits/{activation_height + 10}": "5/10"}},
            activation_height,
        )
        self.nodes[0].generate(1)
        ...
        assert_raises_rpc_error(
            -5,
            "Fee direction value must be both, in or out",
            self.nodes[0].setgov,
        ...
        assert_raises_rpc_error(
            -32600,
            "ATTRIBUTES: Cannot set block period while DFIP2203 is active",
            self.nodes[0].setgov,
            {"ATTRIBUTES": {"v0/params/dfip2203/start_block": "0"}},
        )
        assert_raises_rpc_error(
        ...
        self.nodes[0].setgov(
            {
                "ATTRIBUTES": {
                    ...
                    "v0/params/dfip2206f/block_period": "20160",
                }
            }
        )
        self.nodes[0].generate(1)
        ...
        assert_raises_rpc_error(
            -32600,
            "ATTRIBUTES: Cannot set block period while DFIP2206F is active",
            self.nodes[0].setgov,
            {"ATTRIBUTES": {"v0/params/dfip2206f/start_block": "0"}},
        )
        ...
        assert_raises_rpc_error(
            -32600,
            "called before GrandCentral height",
