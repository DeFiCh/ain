...
class GovsetTest(DefiTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [
            ['-txnotokens=0', '-amkheight=50', '-bayfrontheight=50', '-eunosheight=200', '-fortcanningheight=400',
             '-fortcanninghillheight=1110', '-fortcanningroadheight=1150', '-fortcanningcrunchheight=1200',
    ...
    def run_test(self):
        ...
        #
        symbolGOLD = "GOLD#" + NodeUtil.get_id_token(self.nodes[0], "GOLD")
        symbolSILVER = "SILVER#" + NodeUtil.get_id_token(self.nodes[0], "SILVER")
        ...
        assert (g1 == {
            'LP_SPLITS': {'1': Decimal('0.50000000'), '2': Decimal('0.40000000'), '3': Decimal('0.10000000')}})
        ...
        # Check new subsidy
        assert_equal(self.nodes[0].getgov('LP_DAILY_DFI_REWARD')['LP_DAILY_DFI_REWARD'],
                     Decimal('14843.90592000'))  # 144 blocks a day times 103.08268000
        ...
        assert_equal(self.nodes[0].getgov('LP_DAILY_DFI_REWARD')['LP_DAILY_DFI_REWARD'],
                     Decimal('14597.79395904'))  # 144 blocks a day times 101.37356916
        ...
        assert_equal(self.nodes[0].getgov('LP_DAILY_LOAN_TOKEN_REWARD')['LP_DAILY_LOAN_TOKEN_REWARD'],
                     Decimal('0.00000000'))
        ...
        # Check new subsidy
        assert_equal(self.nodes[0].getgov('LP_DAILY_LOAN_TOKEN_REWARD')['LP_DAILY_LOAN_TOKEN_REWARD'],
                     Decimal('14156.13182400'))  # 144 blocks a day times 98.30647100
        ...
        assert_equal(self.nodes[0].getgov('LP_DAILY_LOAN_TOKEN_REWARD')['LP_DAILY_LOAN_TOKEN_REWARD'],
                     Decimal('13921.42315824'))  # 144 blocks a day times 96.67654971
        ...
        self.nodes[0].generate(1)
        assert_equal(self.nodes[0].getgov("LOAN_LIQUIDATION_PENALTY")["LOAN_LIQUIDATION_PENALTY"],
                     Decimal('0.01000000'))
        ...
        assert_equal(self.nodes[0].getgov('LP_SPLITS')['LP_SPLITS'],
                     {'1': Decimal('0.40000000'), '2': Decimal('0.20000000'), '3': Decimal('0.40000000')})
        ...
        assert_equal(self.nodes[0].getgov('LP_SPLITS')['LP_SPLITS'],
                     {'1': Decimal('0.70000000'), '2': Decimal('0.20000000'), '3': Decimal('0.10000000')})
        ...
        assert_equal(self.nodes[0].getgov('LP_LOAN_TOKEN_SPLITS')['LP_LOAN_TOKEN_SPLITS'],
                     {'1': Decimal('0.10000000'), '2': Decimal('0.20000000'), '3': Decimal('0.70000000')})
        ...
        assert_equal(result[5][0]['LP_SPLITS'],
                     {'1': Decimal('0.70000000'), '2': Decimal('0.20000000'), '3': Decimal('0.10000000')})
        ...
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before FortCanningHill", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/5/payback_dfi': 'true'}})
        ...
        assert_raises_rpc_error(-5,
                                ...
                                self.nodes[0].setgov, {"ATTRIBUTES": {'v0/token/5/unrecognised': 'true'}})
        assert_raises_rpc_error(-5,
                                "Unrecognised key argument provided, valid keys are: members, mint_limit, mint_limit_daily,",
                                self.nodes[0].setgov, {"ATTRIBUTES": {'v0/consortium/5/unrecognised': 'true'}})
        assert_raises_rpc_error(-5, "Value must be an integer", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/not_a_number/payback_dfi': 'true'}})
        assert_raises_rpc_error(-5, 'Boolean value must be either "true" or "false"', self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/5/payback_dfi': 'not_a_number'}})
        assert_raises_rpc_error(-5, 'Boolean value must be either "true" or "false"', self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/5/payback_dfi': 'unrecognised'}})
        assert_raises_rpc_error(-5, "Amount must be a positive value", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/5/payback_dfi_fee_pct': 'not_a_number'}})
        assert_raises_rpc_error(-5, "Amount must be a positive value", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/5/payback_dfi_fee_pct': '-1'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: No such loan token (5)", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/5/payback_dfi': 'true'}})
        assert_raises_rpc_error(-5, "Boolean value must be either \"true\" or \"false\"", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2201/active': 'not_a_bool'}})
        assert_raises_rpc_error(-5, "Amount must be a positive value", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2201/minswap': '-1'}})
        assert_raises_rpc_error(-5, "Amount must be a positive value", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2201/minswap': 'not_a_number'}})
        assert_raises_rpc_error(-5, "Amount must be a positive value", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2201/premium': 'not_a_number'}})
        assert_raises_rpc_error(-5, "Amount must be a positive value", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2201/premium': '-1'}})
        assert_raises_rpc_error(-5, "Unsupported type for DFIP2201", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2201/reward_pct': '0.1'}})
        assert_raises_rpc_error(-5, "Unsupported type for DFIP2201", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2201/block_period': '2880'}})
        assert_raises_rpc_error(-5, "Percentage exceeds 100%", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2201/premium': '1.00000001'}})

        # Check DFIP2203 attributes cannot be set before FCR
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before FortCanningRoad", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2203/active': 'true'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before FortCanningRoad", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2203/reward_pct': '0.05'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before FortCanningRoad", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2203/block_period': '2880'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before FortCanningRoad", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/5/dfip2203': 'true'}})
        ...
        self.nodes[0].generate(1)
        assert_equal(self.nodes[0].getgov('ATTRIBUTES')['ATTRIBUTES'],
                     {'v0/token/5/payback_dfi': 'true', 'v0/token/5/payback_dfi_fee_pct': '0.05'})
        assert_equal(self.nodes[0].listgovs()[8][0]['ATTRIBUTES'],
                     {'v0/token/5/payback_dfi': 'true', 'v0/token/5/payback_dfi_fee_pct': '0.05'})

        # Test setting multiple ATTRIBUTES
        self.nodes[0].setgov(
            {"ATTRIBUTES": {'v0/token/5/payback_dfi': 'false', 'v0/token/5/payback_dfi_fee_pct': '0.02378'}})
        self.nodes[0].generate(1)
        assert_equal(self.nodes[0].getgov('ATTRIBUTES')['ATTRIBUTES'],
                     {'v0/token/5/payback_dfi': 'false', 'v0/token/5/payback_dfi_fee_pct': '0.02378'})

        # Test pending change
        activate = self.nodes[0].getblockcount() + 10
        self.nodes[0].setgovheight(
            {"ATTRIBUTES": {'v0/token/5/payback_dfi': 'true', 'v0/token/5/payback_dfi_fee_pct': '0.01'}}, activate)
        self.nodes[0].generate(9)
        ...
        assert_equal(self.nodes[0].listgovs()[8][1][str(activate)],
                     {'v0/token/5/payback_dfi': 'true', 'v0/token/5/payback_dfi_fee_pct': '0.01'})
        ...
        # Test params
        self.nodes[0].setgov({"ATTRIBUTES": {'v0/params/dfip2201/active': 'true', 'v0/params/dfip2201/minswap': '0.001',
                                             'v0/params/dfip2201/premium': '0.025'}})
        self.nodes[0].generate(1)
        assert_equal(self.nodes[0].getgov('ATTRIBUTES')['ATTRIBUTES'],
                     {'v0/params/dfip2201/active': 'true', 'v0/params/dfip2201/premium': '0.025',
                      'v0/params/dfip2201/minswap': '0.001', 'v0/token/5/payback_dfi': 'true',
                      'v0/token/5/payback_dfi_fee_pct': '0.01'})
        assert_equal(self.nodes[0].listgovs()[8][0]['ATTRIBUTES'],
                     {'v0/params/dfip2201/active': 'true', 'v0/params/dfip2201/premium': '0.025',
                      'v0/params/dfip2201/minswap': '0.001', 'v0/token/5/payback_dfi': 'true',
                      'v0/token/5/payback_dfi_fee_pct': '0.01'})
        ...
        self.nodes[0].setgov({"ATTRIBUTES": {'v0/token/5/loan_payback/1': 'true', 'v0/token/5/loan_payback/2': 'true',
                                             'v0/token/5/loan_payback_fee_pct/1': '0.25'}})
        self.nodes[0].generate(1)
        ...
        self.nodes[0].setgov(
            {"ATTRIBUTES": {'v0/token/5/loan_payback/0': 'true', 'v0/token/5/loan_payback_fee_pct/0': '0.33'}})
        self.nodes[0].generate(1)
        ...
        assert_raises_rpc_error(-5, "Boolean value must be either \"true\" or \"false\"", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2203/active': 'not_a_bool'}})
        assert_raises_rpc_error(-5, "Amount must be a positive value", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2203/reward_pct': 'not_a_number'}})
        assert_raises_rpc_error(-5, "Amount must be a positive value", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2203/reward_pct': '-1'}})
        assert_raises_rpc_error(-5, "Percentage exceeds 100%", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2203/reward_pct': '2'}})
        assert_raises_rpc_error(-5, "Value must be a positive integer", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2203/block_period': 'not_a_number'}})
        assert_raises_rpc_error(-5, "Value must be a positive integer", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2203/block_period': '-1'}})
        assert_raises_rpc_error(-5, "Boolean value must be either \"true\" or \"false\"", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/5/dfip2203': 'not_a_bool'}})
        assert_raises_rpc_error(-32600, "No such loan token", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/4/dfip2203': 'true'}})
        assert_raises_rpc_error(-5, "Unsupported type for this DFIP", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2203/premium': '0.025'}})
        assert_raises_rpc_error(-5, "Unsupported type for this DFIP", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2203/minswap': '0.025'}})
        ...
        assert_equal(result[0][0], {
            'ATTRIBUTES': {'v0/token/5/payback_dfi': 'true', 'v0/token/5/payback_dfi_fee_pct': '0.33',
                           'v0/token/5/loan_payback/1': 'true', 'v0/token/5/loan_payback/2': 'true',
                           'v0/token/5/loan_payback_fee_pct/1': '0.25', 'v0/token/5/dex_in_fee_pct': '0.6',
                           'v0/token/5/dex_out_fee_pct': '0.12', 'v0/token/5/dfip2203': 'true'}})
        ...
        # Verify attributes
        assert_equal(result[0][0], {
            'ATTRIBUTES': {'v0/token/5/loan_payback/1': 'true', 'v0/token/5/loan_payback/2': 'true',
                           'v0/token/5/loan_payback_fee_pct/1': '0.25'}})
        ...
        assert_equal(result, [[{'ICX_TAKERFEE_PER_BTC': Decimal('0.00200000')}],
                              [{'LP_DAILY_LOAN_TOKEN_REWARD': Decimal('13020.86331792')}], [{'LP_LOAN_TOKEN_SPLITS': {
                '1': Decimal('0.10000000'), '2': Decimal('0.20000000'), '3': Decimal('0.70000000')}}],
                              [{'LP_DAILY_DFI_REWARD': Decimal('13427.10581184')}],
                              [{'LOAN_LIQUIDATION_PENALTY': Decimal('0.01000000')}], [{'LP_SPLITS': {
                '1': Decimal('0.70000000'), '2': Decimal('0.20000000'), '3': Decimal('0.10000000')}}],
                              [{'ORACLE_BLOCK_INTERVAL': 30}], [{'ORACLE_DEVIATION': Decimal('0.07000000')}], []])
        ...
        assert_equal(result, [[{'ICX_TAKERFEE_PER_BTC': Decimal('0.00200000')}],
                ...
                '1': Decimal('0.70000000'), '2': Decimal('0.20000000'), '3': Decimal('0.10000000')}}],
                              [{'ORACLE_BLOCK_INTERVAL': 30}], [{'ORACLE_DEVIATION': Decimal('0.07000000')}], [{
                                                                                                                   'ATTRIBUTES': {
                                                                                                                       'v0/params/dfip2201/active': 'true',
                                                                                                                       'v0/params/dfip2201/premium': '0.025',
                                                                                                                       ...
                                                                                                                       'v0/params/dfip2203/block_period': '20160',
                                                                                                                       'v0/token/5/payback_dfi': 'true',
                                                                                                                       'v0/token/5/payback_dfi_fee_pct': '0.33',
                                                                                                                       'v0/token/5/loan_payback/1': 'true',
                                                                                                                       'v0/token/5/loan_payback/2': 'true',
                                                                                                                       'v0/token/5/loan_payback_fee_pct/1': '0.25',
                                                                                                                       'v0/token/5/dex_in_fee_pct': '0.6',
                                                                                                                       'v0/token/5/dex_out_fee_pct': '0.12',
                                                                                                                       'v0/token/5/dfip2203': 'true'}}]])

        # Check errors
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before FortCanningCrunch", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/locks/token/5': 'true'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before FortCanningCrunch", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/oracles/splits/4000': '1/50'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before FortCanningCrunch", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/5/fixed_interval_price_id': 'TSLA/USD'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before FortCanningCrunch", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/5/loan_collateral_enabled': 'true'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before FortCanningCrunch", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/5/loan_collateral_factor': '1.00000000'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before FortCanningCrunch", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/5/loan_minting_enabled': 'true'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before FortCanningCrunch", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/5/loan_minting_interest': '5.00000000'}})

        # Move to FCC fork
        self.nodes[0].generate(1200 - self.nodes[0].getblockcount())

        # Check errors
        assert_raises_rpc_error(-5, "Unrecognised locks argument provided, valid lockss are: token,",
                                self.nodes[0].setgov, {"ATTRIBUTES": {'v0/locks/oracle/5': 'true'}})
        assert_raises_rpc_error(-32600, "No loan token with id (4)", self.nodes[0].setgov,
        ...
        assert_raises_rpc_error(-5, "Mutliplier cannot be zero", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/oracles/splits/1201': '1/0'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Token (127) does not exist", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/oracles/splits/1201': '127/50'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Only DATs can be split", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/oracles/splits/1201': '128/50'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Tokenised DFI cannot be split", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/oracles/splits/1201': '0/50'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Pool tokens cannot be split", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/oracles/splits/1201': '1/50'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set at or below current height", self.nodes[0].setgov,
                                {"ATTRIBUTES": {f'v0/oracles/splits/{self.nodes[0].getblockcount()}': '5/50'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set at or below current height", self.nodes[0].setgov,
                                {"ATTRIBUTES": {f'v0/oracles/splits/{self.nodes[0].getblockcount() + 1}': '5/50'}})
        assert_raises_rpc_error(-32600,
                                ...
                                self.nodes[0].setgovheight, {"ATTRIBUTES": {f'v0/oracles/splits/2000': '5/50'}}, 2000)
        assert_raises_rpc_error(-32600, "No loan token with id (4)", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/oracles/splits/4000': '4/2'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Price feed DUFF/USD does not belong to any oracle",
                                self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/5/fixed_interval_price_id': 'DUFF/USD'}})
        assert_raises_rpc_error(-5, "Empty token / currency", self.nodes[0].setgov,
        ...
        assert_raises_rpc_error(-32600, "No such token (127)", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/127/fixed_interval_price_id': 'TSLA/USD'}})
        assert_raises_rpc_error(-5, "Exactly two entires expected for currency pair", self.nodes[0].setgov,
        ...
        assert_raises_rpc_error(-32600, "Fixed interval price currency pair must be set first", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/5/loan_collateral_enabled': 'true'}})
        assert_raises_rpc_error(-5, "Amount must be a positive value", self.nodes[0].setgov,
        ...
        assert_raises_rpc_error(-32600, "Fixed interval price currency pair must be set first", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/token/5/loan_minting_enabled': 'true'}})
        assert_raises_rpc_error(-32600, "Amount must be a positive value", self.nodes[0].setgov,
        ...
        self.nodes[0].setgov({"ATTRIBUTES": {f'v0/token/4/fixed_interval_price_id': 'TSLA/USD',
                                             f'v0/token/4/loan_minting_enabled': 'true',
                                             f'v0/token/4/loan_minting_interest': '1'}})
        self.nodes[0].generate(1)
        ...
        # Set split
        activation_height = self.nodes[0].getblockcount() + 5
        self.nodes[0].setgovheight({"ATTRIBUTES": {f'v0/oracles/splits/{activation_height + 10}': '5/10'}},
                                   activation_height)
        self.nodes[0].generate(1)
        ...
        assert_raises_rpc_error(-32600, "Cannot be set before FortCanningSpringHeight", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/poolpairs/3/token_a_fee_direction': 'both'}})
        assert_raises_rpc_error(-32600, "Cannot be set before FortCanningSpringHeight", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/poolpairs/3/token_b_fee_direction': 'both'}})
        assert_raises_rpc_error(-32600, "Cannot be set before FortCanningSpringHeight", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2206f/active': 'true'}})
        assert_raises_rpc_error(-32600, "Cannot be set before FortCanningSpringHeight", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2206f/reward_pct': '0.05'}})
        assert_raises_rpc_error(-32600, "Cannot be set before FortCanningSpringHeight", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2206f/block_period': '2880'}})
        assert_raises_rpc_error(-32600, "Cannot be set before FortCanningSpringHeight", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2203/start_block': '0'}})
        assert_raises_rpc_error(-32600, "Cannot be set before FortCanningSpringHeight", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2206f/start_block': '0'}})

        # Move to fork
        self.nodes[0].generate(1250 - self.nodes[0].getblockcount())

        # Test invalid calls
        assert_raises_rpc_error(-5, "Fee direction value must be both, in or out", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/poolpairs/3/token_a_fee_direction': 'invalid'}})
        assert_raises_rpc_error(-5, "Boolean value must be either \"true\" or \"false\"", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2206f/active': 'not_a_bool'}})
        assert_raises_rpc_error(-5, "Amount must be a positive value", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2206f/reward_pct': 'not_a_number'}})
        assert_raises_rpc_error(-5, "Amount must be a positive value", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2206f/reward_pct': '-1'}})
        assert_raises_rpc_error(-5, "Percentage exceeds 100%", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2206f/reward_pct': '2'}})
        assert_raises_rpc_error(-5, "Value must be a positive integer", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2206f/block_period': 'not_a_number'}})
        assert_raises_rpc_error(-5, "Value must be a positive integer", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2206f/block_period': '-1'}})
        assert_raises_rpc_error(-5, "Unsupported type for this DFIP", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2206f/premium': '0.025'}})
        assert_raises_rpc_error(-5, "Unsupported type for this DFIP", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2206f/minswap': '0.025'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot set block period while DFIP2203 is active",
                                self.nodes[0].setgov, {"ATTRIBUTES": {'v0/params/dfip2203/start_block': '0'}})
        assert_raises_rpc_error(-5, "Boolean value must be either \"true\" or \"false\"", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2206a/dusd_interest_burn': 'not_a_bool'}})
        assert_raises_rpc_error(-5, "Boolean value must be either \"true\" or \"false\"", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/dfip2206a/dusd_loan_burn': 'not_a_bool'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before GrandCentral", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/consortium/5/members': {"01": {"name": "test",
                                                                                   "ownerAddress": owner,
                                                                                   "backingId": "blablabla",
        ...
        self.nodes[0].setgov({"ATTRIBUTES": {'v0/params/dfip2206a/dusd_interest_burn': 'true',
                                             'v0/params/dfip2206a/dusd_loan_burn': 'true'}})
        self.nodes[0].generate(1)
        ...
        self.nodes[0].setgov(
            {"ATTRIBUTES": {'v0/params/dfip2206f/reward_pct': '0.05', 'v0/params/dfip2206f/block_period': '20160'}})
        self.nodes[0].generate(1)
        ...
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot set block period while DFIP2206F is active",
                                self.nodes[0].setgov, {"ATTRIBUTES": {'v0/params/dfip2206f/start_block': '0'}})
        ...
        assert_raises_rpc_error(-32600, "called before GrandCentral height", self.nodes[0].unsetgov, {
            'ATTRIBUTES': ['v0/locks/token/4', 'v0/params/dfip2206f/active', 'v0/token/4/fixed_interval_price_id',
                           'v0/oracles/splits/4000', 'v0/poolpairs/3/token_a_fee_direction']})
        assert_raises_rpc_error(-32600, "Cannot be set before GrandCentralHeight", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/params/feature/gov-unset': 'true'}})

        # Move to GrandCentral
        self.nodes[0].generate(1300 - self.nodes[0].getblockcount())

        assert_raises_rpc_error(-5, "Invalid ownerAddress in consortium member data", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/consortium/4/members': {"01": {"name": "test",
                                                                                   "ownerAddress": "",
                                                                                   "backingId": "blablabla",
                                                                                   "mintLimit": 10.00000000}}}})
        assert_raises_rpc_error(-5, "Member name too short, must be at least 3 chars long", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/consortium/4/members': {"01": {"name": "12",
                                                                                   "ownerAddress": owner,
                                                                                   "backingId": "blablabla",
                                                                                   "mintLimit": 10.00000000}}}})
        assert_raises_rpc_error(-5, "Mint limit is an invalid amount", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/consortium/4/members': {"01": {"name": "test",
                                                                                   "ownerAddress": owner,
                                                                                   "backingId": "blablabla",
                                                                                   "mintLimit": -10.00000000}}}})
        assert_raises_rpc_error(-5, "Daily mint limit is an invalid amount", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/consortium/4/members': {"01": {"name": "test",
                                                                                   "ownerAddress": owner,
                                                                                   "backingId": "blablabla",
                                                                                   "mintLimit": 10.00000000,
                                                                                   "mintLimitDaily": -10.00000000}}}})
        assert_raises_rpc_error(-5, "Status must be a positive number", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/consortium/4/members': {"01": {"name": "test",
                                                                                   "ownerAddress": owner,
                                                                                   "backingId": "blablabla",
                                                                                   "mintLimit": 10.00000000,
                                                                                   ...
                                                                                   "status": -1}}}})
        assert_raises_rpc_error(-5, "Status can be either 0 or 1", self.nodes[0].setgov, {"ATTRIBUTES": {
            'v0/consortium/4/members': {
                "01": {"name": "test", "ownerAddress": owner, "backingId": "blablabla", "mintLimit": 10.00000000,
                       "mintLimitDaily": 1.00000000, "status": 2}}}})

        self.nodes[0].setgov(
            {"ATTRIBUTES": {'v0/consortium/5/mint_limit': '10', 'v0/consortium/5/mint_limit_daily': '1'}})
        self.nodes[0].generate(1)
        ...
        assert_raises_rpc_error(-5, "Percentage exceeds 100%", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/gov/proposals/fee_burn_pct': '1.23'}})
        assert_raises_rpc_error(-5, "Percentage exceeds 100%", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/gov/proposals/fee_burn_pct': '101%'}})
        assert_raises_rpc_error(-5, "Percentage exceeds 100%", self.nodes[0].setgov,
                                {"ATTRIBUTES": {'v0/gov/proposals/cfp_fee': '101.66%'}})
        ...
        assert_raises_rpc_error(-32600, "Unset Gov variables not currently enabled in attributes.",
                                self.nodes[0].unsetgov, {
                                    'ATTRIBUTES': ['v0/locks/token/4', 'v0/params/dfip2206f/active',
                                                   'v0/token/4/fixed_interval_price_id', 'v0/oracles/splits/4000',
        ...
        # Unset Gov variables
        self.nodes[0].unsetgov({'ATTRIBUTES': ['v0/locks/token/4', 'v0/params/dfip2206f/active',
                                               'v0/token/4/fixed_interval_price_id', 'v0/oracles/splits/4000',
                                               'v0/poolpairs/3/token_a_fee_direction']})
        self.nodes[0].generate(1)
