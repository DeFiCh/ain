...
class GovsetTest (DefiTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [
            ['-txnotokens=0', '-amkheight=50', '-bayfrontheight=50', '-eunosheight=200', '-fortcanningheight=400', '-fortcanninghillheight=1110', '-fortcanningroadheight=1150', '-fortcanningspicegardenheight=1200', '-subsidytest=1'],
            ['-txnotokens=0', '-amkheight=50', '-bayfrontheight=50', '-eunosheight=200', '-fortcanningheight=400', '-fortcanninghillheight=1110', '-fortcanningroadheight=1150', '-fortcanningspicegardenheight=1200', '-subsidytest=1']]
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before FortCanningSpiceGarden", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/token/5/fixed_interval_price_id':'TSLA/USD'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before FortCanningSpiceGarden", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/token/5/loan_collateral_enabled':'true'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before FortCanningSpiceGarden", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/token/5/loan_collateral_factor':'1.00000000'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before FortCanningSpiceGarden", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/token/5/loan_minting_enabled':'true'}})
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before FortCanningSpiceGarden", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/token/5/loan_minting_interest':'5.00000000'}})
