...
class GovsetTest (DefiTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Unrecognised type argument provided, valid types are: consortium, governance, locks, oracles, params, poolpairs, token,", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/unrecognised/5/payback_dfi':'true'}})
        ...
        assert_raises_rpc_error(-5, "Unrecognised key argument provided, valid keys are: daily_mint_limit, enable, members, mint_limit,", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/consortium/5/unrecognised':'true'}})
        ...
        assert_raises_rpc_error(-32600, "Cannot be set before FortCanningSpringHeight", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/poolpairs/3/token_a_fee_direction': 'both'}})
        assert_raises_rpc_error(-32600, "Cannot be set before FortCanningSpringHeight", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/poolpairs/3/token_b_fee_direction': 'both'}})
        assert_raises_rpc_error(-32600, "Cannot be set before FortCanningSpringHeight", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/params/dfip2206f/active':'true'}})
        assert_raises_rpc_error(-32600, "Cannot be set before FortCanningSpringHeight", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/params/dfip2206f/reward_pct':'0.05'}})
        assert_raises_rpc_error(-32600, "Cannot be set before FortCanningSpringHeight", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/params/dfip2206f/block_period':'2880'}})
        assert_raises_rpc_error(-32600, "Cannot be set before FortCanningSpringHeight", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/params/dfip2203/start_block':'0'}})
        assert_raises_rpc_error(-32600, "Cannot be set before FortCanningSpringHeight", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/params/dfip2206f/start_block':'0'}})
        ...
        assert_raises_rpc_error(-32600, "ATTRIBUTES: Cannot be set before GrandCentral", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/consortium/config/enable':'true'}})
        ...
        assert_raises_rpc_error(-5, "Unsupported key for Consortium token section", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/consortium/1/enable':'true'}})
        ...
        assert_raises_rpc_error(-5, "Mint limit is an invalid amount", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/consortium/4/members' : '{"01":{"name":"test", \
                                                                                                                                           ...
                                                                                                                                           "backingId":"blablabla", \
                                                                                                                                           "mintLimit":-10.00000000}}'}})
        assert_raises_rpc_error(-5, "Daily mint limit is an invalid amount", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/consortium/4/members' : '{"01":{"name":"test", \
                                                                                                                                           "ownerAddress":"' + owner +'", \
                                                                                                                                           "backingId":"blablabla", \
                                                                                                                                           "mintLimit":10.00000000, \
