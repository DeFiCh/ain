...
class GovsetTest (DefiTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].setgov({"ATTRIBUTES":{'v0/params/dfip2203/active':'true','v0/params/dfip2203/reward_pct':'0.05','v0/params/dfip2203/block_period':'20160','v0/token/5/dfip2203_disabled':'true'}})
        self.nodes[0].generate(1)
