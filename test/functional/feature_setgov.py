...
class GovsetTest (DefiTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Unrecognised type argument provided, valid types are: governance, locks, oracles, params, poolpairs, token,", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/unrecognised/5/payback_dfi':'true'}})
