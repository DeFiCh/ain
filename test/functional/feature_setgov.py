...
class GovsetTest (DefiTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Amount must be a float", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/token/5/payback_dfi_fee_pct':'not_a_number'}})
        assert_raises_rpc_error(-5, "Amount must be a float", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/token/5/payback_dfi_fee_pct':'-1'}})
        ...
        assert_raises_rpc_error(-5, "Amount must be a float", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/params/dfip2201/minswap':'not_a_number'}})
        assert_raises_rpc_error(-5, "Amount must be a float", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/params/dfip2201/premium': 'not_a_number'}})
        assert_raises_rpc_error(-5, "Percentage exceeds 100%", self.nodes[0].setgov, {"ATTRIBUTES":{'v0/params/dfip2201/premium': '10'}})
