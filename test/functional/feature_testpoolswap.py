...
class PoolPairTestPoolSwapTest(DefiTestFramework):
    ...
    def setup(self):
        ...
        self.nodes[0].addpoolliquidity(
            {self.mn_address: ["10000@" + self.symbolDFI, "10000@" + self.symbolDUSD]},
            self.mn_address,
        )
        self.nodes[0].addpoolliquidity(
            {self.mn_address: ["10000@" + self.symbolTSLA, "10000@" + self.symbolDFI]},
            self.mn_address,
        )
        self.nodes[0].addpoolliquidity(
            {self.mn_address: ["10000@" + self.symbolTSLA, "10000@" + self.symbolBTC]},
            self.mn_address,
        )
        self.nodes[0].generate(1)
    ...
    def test_testpoolswap_with_token_a_fee_in_token_b_fee_in(
        self, swap_fn, tokenFrom, path
    ):
        self.nodes[0].setgov(
            {
                "ATTRIBUTES": {
    ...
    def test_testpoolswap_with_token_a_fee_in_token_b_fee_out(
        self, swap_fn, tokenFrom, path
    ):
        self.nodes[0].setgov(
            {
    ...
    def test_testpoolswap_with_token_a_fee_out_token_b_fee_in(
        self, swap_fn, tokenFrom, path
    ):
        self.nodes[0].setgov(
            {
    ...
    def test_testpoolswap_with_token_a_fee_out_token_b_fee_out(
        self, swap_fn, tokenFrom, path
    ):
        self.nodes[0].setgov(
            {
    ...
    def run_test(self):
        ...
        combinations = [
            ...
            (
                ...
                self.symbolTSLA,
                [str(self.DFI_TSLAPoolID), str(self.DUSD_DFIPoolID)],
            ),
            ...
            (
                ...
                self.symbolBTC,
                [
                    str(self.BTC_TSLAPoolID),
                    str(self.DFI_TSLAPoolID),
                    str(self.DUSD_DFIPoolID),
                ],
            ),
        ]
