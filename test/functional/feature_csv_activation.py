...
class BIP68_112_113Test(DefiTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [
            ["-whitelist=127.0.0.1", "-blockversion=4", "-addresstype=legacy"]
        ]
    ...
    def run_test(self):
        ...
        self.log.info(
            "Height = {}, CSV not yet active (will activate for block {}, not {})".format(
                self.tipheight, CSV_ACTIVATION_HEIGHT, CSV_ACTIVATION_HEIGHT - 1
            )
        )
