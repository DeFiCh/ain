...
class AddressTypeTest(DefiTestFramework):
    ...
    def test_desc(self, node, address, multisig, typ, utxo):
        ...
        if not multisig and typ == "legacy":
            # P2PKH
            assert_equal(
                info["desc"], descsum_create("pkh(%s)" % key_descs[info["pubkey"]])
            )
        elif not multisig and typ == "p2sh-segwit":
            # P2SH-P2WPKH
            assert_equal(
                info["desc"], descsum_create("sh(wpkh(%s))" % key_descs[info["pubkey"]])
            )
        elif not multisig and typ == "bech32":
            # P2WPKH
            assert_equal(
                info["desc"], descsum_create("wpkh(%s)" % key_descs[info["pubkey"]])
            )
        elif typ == "legacy":
            # P2SH-multisig
            assert_equal(
    ...
    def test_change_output_type(self, node_sender, destinations, expected_type):
        ...
        self.log.debug(
            "Check if change address " + change_addresses[0] + " is " + expected_type
        )
        self.test_address(
    ...
    def run_test(self):
        ...
        for node in range(4):
            ...
            self.test_address(
                node,
                self.nodes[node].addmultisigaddress(2, [compressed_1, uncompressed_2])[
                    "address"
                ],
                True,
                "legacy",
            ...
            self.test_address(
                node,
                self.nodes[node].addmultisigaddress(2, [uncompressed_1, compressed_2])[
                    "address"
                ],
                True,
                "legacy",
        ...
        self.test_address(
            1,
            self.nodes[1].addmultisigaddress(2, [compressed_1, compressed_2])[
                "address"
            ],
            True,
            "p2sh-segwit",
        ...
        self.test_address(
            2,
            self.nodes[2].addmultisigaddress(2, [compressed_1, compressed_2])[
                "address"
            ],
            True,
            "p2sh-segwit",
        ...
        self.test_address(
            3,
            self.nodes[3].addmultisigaddress(2, [compressed_1, compressed_2])[
                "address"
            ],
            True,
            "bech32",
        ...
        self.test_address(
            4, self.nodes[4].getrawchangeaddress(), multisig=False, typ="p2sh-segwit"
        )
        ...
        self.test_address(
            4, self.nodes[4].getrawchangeaddress("bech32"), multisig=False, typ="bech32"
        )
