...
class LoanGetInterestTest(DefiTestFramework):
    ...
    def setup(self):
        ...
        self.nodes[0].addpoolliquidity(
            {self.account0: ["30@" + self.symbolDFI, "300@" + self.symboldUSD]},
            self.account0,
        )
        self.nodes[0].generate(1)
    ...
    def run_test(self):
        ...
        self.nodes[0].takeloan(
            {"vaultId": vaultId, "amounts": "2000@" + self.symboldUSD}
        )
        self.nodes[0].generate(1)
        ...
        self.nodes[0].takeloan(
            {"vaultId": vaultId, "amounts": "500@" + self.symboldUSD}
        )
        self.nodes[0].generate(1)
        ...
        self.nodes[0].takeloan(
            {"vaultId": vaultId, "amounts": "500.2@" + self.symboldUSD}
        )
        self.nodes[0].generate(1)
        ...
        self.nodes[0].takeloan(
            {"vaultId": vaultId, "amounts": "0.00000001@" + self.symboldUSD}
        )
        self.nodes[0].generate(1)
        ...
        self.nodes[0].takeloan(
            {"vaultId": vaultId, "amounts": "50000.00000001@" + self.symboldUSD}
        )
        self.nodes[0].generate(1)
