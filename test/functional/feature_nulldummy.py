...
class NULLDUMMYTest(DefiTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [
            ["-whitelist=127.0.0.1", "-segwitheight=432", "-addresstype=legacy"]
        ]
    ...
    def run_test(self):
        ...
        test1txs = [
            create_transaction(
                self.nodes[0], coinbase_txid[0], self.ms_address, amount=49
            )
        ]
        ...
        test1txs.append(
            create_transaction(self.nodes[0], txid1, self.ms_address, amount=48)
        )
        ...
        test1txs.append(
            create_transaction(
                self.nodes[0], coinbase_txid[1], self.wit_ms_address, amount=49
            )
        )
        ...
        test4tx = create_transaction(
            self.nodes[0], test2tx.hash, self.address, amount=46
        )
