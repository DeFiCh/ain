...
class BlockchainTest(DefiTestFramework):
    ...
    def _test_getblockchaininfo(self):
        ...
        assert_equal(res['softforks'], {
            ...
            'changiintermediate2': {'type': 'buried', 'active': False, 'height': 10000000},
            'changiintermediate3': {'type': 'buried', 'active': False, 'height': 10000000},
            'changiintermediate4': {'type': 'buried', 'active': False, 'height': 10000000},
            'testdummy': {
                'type': 'bip9',
                'bip9': {
                    'status': 'started',
