...
class CreateLoanSchemeTest(DefiTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            errorString = e.error["message"]
        assert (
            "Loan scheme LOANMAX with same interestrate and mincolratio already exists"
            in errorString
        )
        ...
        try:
            ...
            errorString = e.error["message"]
        assert (
            "Loan scheme LOAN0001 with same interestrate and mincolratio already exists"
            in errorString
        )
        ...
        try:
            ...
            errorString = e.error["message"]
        assert (
            "Update height below current block height, set future height" in errorString
        )
        ...
        try:
            ...
            errorString = e.error["message"]
        assert (
            "Loan scheme LOANMAX with same interestrate and mincolratio pending on block 115"
            in errorString
        )
        ...
        try:
            ...
            errorString = e.error["message"]
        assert (
            "Cannot destroy default loan scheme, set new default first" in errorString
        )
        ...
        # Move to destruction block and check
        ...
        try:
            ...
            errorString = e.error["message"]
        assert (
            "Loan scheme LOAN0002 with same interestrate and mincolratio pending on block 131"
            in errorString
        )
