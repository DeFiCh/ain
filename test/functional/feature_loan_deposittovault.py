    ...
    def run_test(self):
        ...
        try:
            self.nodes[0].deposittovault(
                "76a9148080dad765cbfd1c38f95e88592e24e43fb642828a948b2a457a8ba8ac",
                accountDFI,
                "1@DFI",
            )
        except JSONRPCException as e:
            errorString = e.error["message"]
        assert (
            "Vault <76a9148080dad765cbfd1c38f95e88592e24e43fb642828a948b2a457a8ba8ac> not found"
            in errorString
        )
        ...
        self.nodes[0].takeloan({"vaultId": vaultId1, "amounts": "0.5@TSLA"})
        ...
        self.nodes[0].generate(
            6
        )  # let fixed price be stable and check vault is now underLiquidation state
        self.sync_blocks()
