...
class PaybackDFILoanTest (DefiTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].setgov({"ATTRIBUTES":{'v0/params/dfip2206/direct_interest_dusd_burn':'true', 'v0/token/'+idTSLA+'/loan_payback/'+idBTC: 'true', 'v0/token/'+idTSLA+'/loan_payback/'+iddUSD: 'true'}})
        self.nodes[0].generate(1)
