...
class MempoolAcceptanceTest(DefiTestFramework):
    ...
    def run_test(self):
        ...
        self.check_mempool_result(
            result_expected=[
                {'txid': tx.rehash(), 'allowed': False, 'reject-reason': '16: bad-txns-txouttotal-toolarge'}],
            rawtxs=[tx.serialize().hex()],
        )
        ...
        num_scripts = 100000 // len(
            output_p2sh_burn.serialize())  # Use enough outputs to make the tx too large for our policy
