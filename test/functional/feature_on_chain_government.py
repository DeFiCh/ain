...
class OnChainGovernanceTest(DefiTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(result["feeRewardPerVote"], Decimal("0.625"))
        assert_equal(result["feeRewardTotal"], Decimal("2.5"))
        ...
        assert_equal(result["votesNeutral"], Decimal("0"))
        assert_equal(result["votesInvalid"], Decimal("0"))
        assert_equal(result["feeRewardPerVote"], Decimal("2.5"))
        assert_equal(result["feeRewardTotal"], Decimal("10"))
        assert_equal(result["approvalThreshold"], "50.00%")
