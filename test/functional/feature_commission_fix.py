...
class CommissionFixTest(DefiTestFramework):
    def set_test_params(self):
        ...
        self.greatworld = 200
        self.extra_args = [
            ['-txnotokens=0', '-amkheight=1', '-bayfrontheight=1', '-eunosheight=1', '-fortcanningheight=1', '-fortcanningmuseumheight=1', '-fortcanninghillheight=1', '-fortcanningroadheight=1', '-fortcanningcrunchheight=1', f'-greatworldheight={self.greatworld}', '-subsidytest=1']]
    ...
    def pool_commission(self):
        ...
        # Move to fork
        self.nodes[0].generate(self.greatworld - self.nodes[0].getblockcount())
