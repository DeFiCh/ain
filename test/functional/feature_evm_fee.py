...
class EVMFeeTest(DefiTestFramework):
    ...
    def test_fee_deduction(self):
        ...
        assert_equal(Decimal(attributes['v0/live/economy/evm_fees/burnt']), Decimal('0.00021000'))
        assert_equal(Decimal(attributes['v0/live/economy/evm_fees/paid']), Decimal('0'))
