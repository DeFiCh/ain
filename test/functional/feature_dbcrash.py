...
class ChainstateWriteCrashTest(DefiTestFramework):
    ...
    def restart_node(self, node_index, expected_tip):
        ...
        # If we got here, defid isn't coming back up on restart.  Could be a
        # bug in defid, or we've gotten unlucky with our dbcrash ratio --
