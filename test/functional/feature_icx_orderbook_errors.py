...
class ICXOrderbookErrorTest(DefiTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            errorString = e.error['message']
        assert (
                    "orderTx (76432beb2a667efe4858b4e1ec93979b621c51c76abaab2434892655dd152e3d) does not exist" in errorString)
        ...
        try:
            ...
            errorString = e.error['message']
        assert (
                    "dfc htlc with creation tx 76432beb2a667efe4858b4e1ec93979b621c51c76abaab2434892655dd152e3d does not exists" in errorString)
        ...
        try:
            ...
            errorString = e.error['message']
        assert (
                    "offer (" + offerTx + ") needs to have ext htlc submitted first, but no external htlc found" in errorString)
