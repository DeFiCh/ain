...
class DecodeScriptTest(DefiTestFramework):
    ...
    def decodescript_script_pub_key(self):
        ...
        assert_equal(
            "2 " + public_key + " " + uncompressed_public_key + " 2 OP_CHECKMULTISIG",
            rpc_result["asm"],
        )
        # uncompressed pubkeys are invalid for checksigs in segwit scripts.
        # decodescript should not return a P2WPKH equivalent.
    ...
    def decoderawtransaction_asm_sighashtype(self):
        ...
        rpc_result = self.nodes[0].decoderawtransaction(tx)
        assert_equal(
            "OP_RETURN 300602010002010001", rpc_result["vout"][0]["scriptPubKey"]["asm"]
        )
