...
class RestartdTokensTest(DefiTestFramework):
    ...
    def check_only_lm_case(self):
        ...
        assert_equal(
            ...
            [
                {
                    "owner": lmaddress,
                    "values": ["0.55000056@SPY", "22.42387545@DUSD"],
                },
                {
                    "owner": self.address,
                    "values": ["2.45000008@SPY", "2134.44519763@DUSD"],
                },
                {
                    "owner": self.address1,
                ...
                {
                    "owner": self.address3,
                    "values": ["0.99999930@SPY", "100.01673308@DUSD"],
                },
            ],
        )
    ...
    def check_second_vault_case(self):
        ...
        assert_equal(
            ...
            [
                {
                    "owner": self.address,
                    "values": ["4.00000068@SPY", "2169.87927888@DUSD"],
                },
                {
                    "owner": self.address1,
                    "values": ["75.00908675@DUSD"],
    ...
    def check_td_99(self):
        ...
        assert_equal(
            ...
            ["1.98000000@SPY", "143.41617441@DUSD"],
        )
        assert_equal(
            ...
            [
                ...
                {
                    "owner": self.address1,
                    "values": ["1.60018174@DUSD", "0.02000000@SPY"],
                },
                {
                    "owner": self.address3,
                ...
                {
                    "owner": self.address,
                    "values": ["43.39904218@DUSD", "0.60000020@SPY"],
                },
            ],
        )
    ...
    def release_final_1(self):
        ...
        assert_equal(
            ...
            [
                ...
                "59.00001170@SPY",
                "854.81190994@USDT",
                "94.86637327@USDT-DUSD",
                "99.99999000@BTC-DFI",
            ],
        )
        assert_equal(
            sorted(self.nodes[0].getaccount(self.address1)),
            ["145.01635615@DUSD", "2.00000000@SPY"],
        )
        assert_equal(
        ...
        assert_equal(
            sorted(self.nodes[0].getaccount(self.address3)),
            ["18.99998570@SPY", "190.03348924@DUSD", "3.16230611@SPY-DUSD"],
        )
        assert_equal(
    ...
    def check_token_split(self):
        ...
        assert_equal(
            sorted(self.nodes[0].getaccount(self.address3)),
            ["18.79998580@SPY", "188.03315457@DUSD", "3.16230611@SPY-DUSD"],
        )
        assert_equal(
            sorted(self.nodes[0].getaccount(self.tokenlockaddress)),
            ["0.81000010@SPY", "47.19957592@DUSD"],
        )
    ...
    def release_88(self):
        ...
        assert_equal(
            ...
            [
                ...
                {
                    "owner": self.address,
                    "values": ["0.06000002@SPY", "43.39904218@DUSD"],
                },
                {
                    "owner": self.address2,
                    "values": ["0.20001733@DUSD"],
        ...
        assert_equal(
            sorted(self.nodes[0].getaccount(self.address3)),
            ["0.99999900@SPY-DUSD", "1.87999858@SPY", "188.03315457@DUSD"],
        )
        assert_equal(
            sorted(self.nodes[0].getaccount(self.tokenlockaddress)),
            ["0.08100001@SPY", "47.19957592@DUSD"],
        )
    ...
    def check_td(self):
        ...
        assert_equal(
            ...
            [
                ...
                {
                    "owner": self.address3,
                    "values": ["1.79999874@SPY", "180.03011956@DUSD"],
                },
                {
                    "owner": self.address1,
                    "values": ["135.01635615@DUSD"],
                },
                {
                    "owner": self.address2,
                    "values": ["18.00155935@DUSD"],
                },
                {
                    "owner": self.address,
                    "values": ["5.40000117@SPY", "3905.91379583@DUSD"],
                },
            ],
        )
    ...
    def release_first_1(self):
        ...
        assert_equal(
            ...
            [
                ...
                {
                    "owner": self.address3,
                    "values": ["1.77999876@SPY", "178.02978490@DUSD"],
                },
                {
                    "owner": self.address1,
                    "values": ["133.51617442@DUSD"],
                },
                {
                    "owner": self.address2,
                    "values": ["17.80154203@DUSD"],
                },
                {
                    "owner": self.address,
                    "values": ["5.34000116@SPY", "3862.51475366@DUSD"],
                },
            ],
        )
        ...
        assert_equal(
            sorted(self.nodes[0].getaccount(self.address3)),
            ["0.11999981@SPY", "0.99999900@SPY-DUSD", "12.00370434@DUSD"],
        )
        assert_equal(
            sorted(self.nodes[0].getaccount(self.tokenlockaddress)),
            ["4200.76225501@DUSD", "7.20899992@SPY"],
        )
    ...
    def check_token_lock(self):
            ...
            [
                ...
                },
                {
                    "13": [
                        ...
                        "11",
                        "0",
                        Decimal("266.11508035"),
                        Decimal("60.86907436"),
                        Decimal("127.27206533"),
                    ]
                },
                {
                    "14": [
        ...
        assert_equal(
            ...
            ["5.40000117@SPY", "3905.91379583@DUSD"],
        )
        ...
        assert_equal(
            self.nodes[0].getvault(self.loop_vault_id),
            {
                ...
                "state": "active",
                "collateralAmounts": ["15.00181736@DUSD"],
                "loanAmounts": [],
                "interestAmounts": [],
                "collateralValue": Decimal("15.00181736"),
                "loanValue": 0,
                "interestValue": 0,
                "informativeRatio": -1,
                "collateralRatio": -1,
        ...
        assert_equal(
            self.nodes[0].getvault(self.vault_id1),
            {
                ...
                "ownerAddress": self.address1,
                "state": "active",
                "collateralAmounts": ["0.01000000@BTC", "11.24257533@USDT"],
                "loanAmounts": [],
                "interestAmounts": [],
                "collateralValue": Decimal("511.24257533"),
                "loanValue": Decimal("0E-8"),
                "interestValue": 0,
                "informativeRatio": Decimal("-1.00000000"),
                "collateralRatio": -1,
        ...
        assert_equal(
            self.nodes[0].getvault(self.vault_id2_1),
            {
                ...
                "ownerAddress": self.address2,
                "state": "active",
                "collateralAmounts": ["2.00017327@DUSD"],
                "loanAmounts": [],
                "interestAmounts": [],
                "collateralValue": Decimal("2.00017327"),
                "loanValue": 0,
                "interestValue": 0,
                "informativeRatio": -1,
                "collateralRatio": -1,
        ...
        assert_equal(
            self.nodes[0].getvault(self.vault_id2_2),
            {
                ...
                "ownerAddress": self.address2,
                "state": "active",
                "collateralAmounts": ["0.00996611@BTC"],
                "loanAmounts": [],
                "interestAmounts": [],
                "collateralValue": Decimal("498.30550000"),
                "loanValue": Decimal("0E-8"),
                "interestValue": 0,
                "informativeRatio": Decimal("-1.00000000"),
                "collateralRatio": -1,
        ...
        assert_equal(
            sorted(self.nodes[0].getaccount(self.address3)),
            ["0.09999983@SPY", "0.99999900@SPY-DUSD", "10.00336968@DUSD"],
        )
        assert_equal(
            sorted(self.nodes[0].getaccount(self.tokenlockaddress)),
            ["4238.96183089@DUSD", "7.19999991@SPY"],
        )
