    ...
    def check_only_lm_case(self):
        ...
        assert_equal(
            ...
            [
                {
                    "owner": lmaddress,
                    "values": ["0.55000056@SPY", "22.42913292@DUSD"],
                },
                {
                    "owner": self.address,
                ...
                {
                    "owner": self.address3,
                    "values": ["0.99999930@SPY", "100.01673309@DUSD"],
                },
            ],
        )
    ...
    def check_token_lock(self):
            ...
            [
                ...
                },
                {
                    "13": [
                        ...
                        "11",
                        "0",
                        Decimal("266.13631958"),
                        Decimal("60.87106908"),
                        Decimal("127.27922962"),
                    ]
                },
                {
                    "14": [
        ...
        assert_equal(
            ...
            [
                ...
                {"h": 1000, "t": "Commission", "a": ["1.23927002@DFI"]},
                {"h": 1000, "t": "Commission", "a": ["0.69994603@USDT"]},
        ...
        assert_equal(
            ...
            [
                ...
                {"h": 1000, "t": "Commission", "a": ["0.00000006@BTC"]},
                {"h": 1000, "t": "Commission", "a": ["1.37696669@DFI"]},
                {"h": 1000, "t": "Commission", "a": ["0.77771781@USDT"]},
                {"h": 1000, "t": "blockReward", "a": ["122.11455925@DFI"]},
                {"h": 999, "t": "blockReward", "a": ["122.11455925@DFI"]},
            ],
        )
