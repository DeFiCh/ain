    ...
    def check_token_lock(self):
        ...
        assert_equal(
            ...
            [
                ...
                {"11": ["USDD", True, True, 4791.5364412]},
        ...
        assert_equal(
            ...
            [
                ...
                {
                    "owner": self.address,
                    "values": ["5.400001@SPY", "3907.204657@USDD"],
                },
            ],
        )
        ...
        assert_equal(
            self.nodes[0].getvault(self.vault_id1),
            {
                ...
                "ownerAddress": self.address1,
                "state": "active",
                "collateralAmounts": ["0.01000000@BTC", "11.24041912@USDT"],
                "loanAmounts": [],
                "interestAmounts": [],
                "collateralValue": Decimal("511.24041912"),
                "loanValue": 0,
                "interestValue": 0,
                "informativeRatio": -1,
                "collateralRatio": -1,
        ...
        assert_equal(
            self.nodes[0].getvault(self.vault_id2),
            {
                ...
                "state": "active",
                "collateralAmounts": ["1.50047097@DFI", "0.01000000@BTC"],
                "loanAmounts": [],
                "interestAmounts": [],
                "collateralValue": Decimal("507.50235485"),
                "loanValue": 0,
                "interestValue": 0,
                "informativeRatio": -1,
                "collateralRatio": -1,
