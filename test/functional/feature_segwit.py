...
class SegWitTest(DefiTestFramework):
    ...
    def run_test(self):
        ...
        for i in range(3):
            ...
            multiscript = CScript(
                [OP_1, hex_str_to_bytes(self.pubkey[-1]), OP_1, OP_CHECKMULTISIG]
            )
        ...
        self.fail_accept(
            ...
            p2sh_ids[NODE_2][WIT_V0][1],
            False,
        )
        self.fail_accept(
            self.nodes[2],
            "mandatory-script-verify-flag",
            p2sh_ids[NODE_2][WIT_V1][1],
            False,
        )
        ...
        blockhash = self.nodes[2].generate(1)[
            0
        ]  # block 432 (first block with new rules; 432 = 144 * 3)
        self.sync_blocks()
        ...
        self.fail_accept(
            self.nodes[0],
            "mandatory-script-verify-flag",
            wit_ids[NODE_0][WIT_V0][0],
            False,
        )
        self.fail_accept(
            self.nodes[0],
            "mandatory-script-verify-flag",
            wit_ids[NODE_0][WIT_V1][0],
            False,
        )
        self.fail_accept(
            self.nodes[0],
            "mandatory-script-verify-flag",
            p2sh_ids[NODE_0][WIT_V0][0],
            False,
        )
        self.fail_accept(
            self.nodes[0],
            "mandatory-script-verify-flag",
            p2sh_ids[NODE_0][WIT_V1][0],
            False,
        )
        ...
        assert self.nodes[2].getblock(blockhash, False) != self.nodes[0].getblock(
            blockhash, False
        )
        assert self.nodes[1].getblock(blockhash, False) == self.nodes[2].getblock(
            blockhash, False
        )
        ...
        assert_equal(
            self.nodes[0].getmempoolentry(txid1)["vsize"],
        ...
        tx.vout.append(
            CTxOut(int(49.99 * COIN), CScript([OP_TRUE, OP_DROP] * 15 + [OP_TRUE]))
        )
        ...
        assert_equal(
            int(self.nodes[0].getmempoolentry(txid2)["wtxid"], 16), tx.calc_sha256(True)
        )

        # Check that weight and vsize are properly reported in mempool entry (txid2)
        assert_equal(
            self.nodes[0].getmempoolentry(txid2)["vsize"],
        ...
        tx.vout.append(
            CTxOut(int(49.95 * COIN), CScript([OP_TRUE, OP_DROP] * 15 + [OP_TRUE]))
        )  # Huge fee
        tx.calc_sha256()
        ...
        assert_equal(
            int(self.nodes[0].getmempoolentry(txid3)["wtxid"], 16), tx.calc_sha256(True)
        )

        # Check that weight and vsize are properly reported in mempool entry (txid3)
        assert_equal(
            self.nodes[0].getmempoolentry(txid3)["vsize"],
        ...
        assert not self.nodes[0].getaddressinfo(uncompressed_spendable_address[0])[
            "iscompressed"
        ]
        assert self.nodes[0].getaddressinfo(compressed_spendable_address[0])[
            "iscompressed"
        ]
        ...
        uncompressed_spendable_address.append(
            self.nodes[0].addmultisigaddress(
                2,
                [uncompressed_spendable_address[0], uncompressed_spendable_address[0]],
            )["address"]
        )
        compressed_spendable_address.append(
            self.nodes[0].addmultisigaddress(
                2, [compressed_spendable_address[0], compressed_spendable_address[0]]
            )["address"]
        )
        ...
        compressed_solvable_address.append(
            self.nodes[0].addmultisigaddress(
                2, [compressed_spendable_address[0], compressed_solvable_address[0]]
            )["address"]
        )
        compressed_solvable_address.append(
            self.nodes[0].addmultisigaddress(
                2, [compressed_solvable_address[0], compressed_solvable_address[1]]
            )["address"]
        )
        ...
        spendable_txid.append(
            self.mine_and_test_listunspent(
                spendable_anytime + spendable_after_importaddress, 2, txs_mined
            )
        )
        solvable_txid.append(
            self.mine_and_test_listunspent(
                solvable_anytime + solvable_after_importaddress, 1, txs_mined
            )
        )
        ...
        uncompressed_solvable_address.append(
            self.nodes[0].addmultisigaddress(
                2, [compressed_solvable_address[0], uncompressed_solvable_address[0]]
            )["address"]
        )
        compressed_solvable_address.append(
            self.nodes[0].addmultisigaddress(
        ...
        for use_p2wsh in [False, True]:
            ...
            assert_equal(
                self.nodes[1].listtransactions("*", 1, 0, True)[0]["txid"], txid
            )
