    ...
    def run_test(self):
        ...
        try:
            self.nodes[0].setcollateraltoken(
                {"token": "DOGE", "factor": 1, "fixedIntervalPriceId": "DFI/USD"}
            )
        ...
        assert_raises_rpc_error(
            -32600,
            "setCollateralToken factor must be lower or equal than 1",
            self.nodes[0].setcollateraltoken,
            {"token": idDFI, "factor": 2, "fixedIntervalPriceId": "DFI/USD"},
        )
        ...
        try:
            self.nodes[0].setcollateraltoken(
                {"token": idDFI, "factor": 1, "fixedIntervalPriceId": "Blabla"}
            )
        except JSONRPCException as e:
            errorString = e.error["message"]
        ...
        collTokenTx1 = self.nodes[0].setcollateraltoken(
            {"token": idDFI, "factor": 0.5, "fixedIntervalPriceId": "DFI/USD"}
        )
        ...
        collToken1 = [
            token for token in collTokens if token["tokenId"] == collTokenTx1
        ][0]
        ...
        collTokenTx2 = self.nodes[0].setcollateraltoken(
            {"token": idBTC, "factor": 0.9, "fixedIntervalPriceId": "BTC/USD"}
        )
        ...
        collToken2 = [
            token for token in collTokens if token["tokenId"] == collTokenTx2
        ][0]
        ...
        collToken3 = [
            token for token in collTokens if token["tokenId"] == collTokenTx3
        ][0]
        ...
        self.nodes[0].setcollateraltoken(
            {"token": idBTC, "factor": 0, "fixedIntervalPriceId": "BTC/USD"}
        )
        ...
        assert_raises_rpc_error(
            -32600,
            "setCollateralToken factor must be lower or equal than 1.00000000",
            self.nodes[0].setcollateraltoken,
            {"token": idDFI, "factor": 1.01, "fixedIntervalPriceId": "DFI/USD"},
        )
