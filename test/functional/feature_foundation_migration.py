...
class FoundationMemberTest(DefiTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [
            [
                ...
                f"-grandcentralheight={self.grand_central}",
                "-subsidytest=1",
            ],
            [
                "-txnotokens=0",
    ...
    def run_test(self):
        ...
        # Remove address
        self.nodes[0].setgov(
            {"ATTRIBUTES": {"v0/params/foundation/members": [f"-{address}"]}}
        )
        self.nodes[0].generate(1)
        ...
        assert_equal(
            attributes[1][str(activation_height)]["v0/params/foundation/members"],
            [
                "-2MwHamtynMqvstggG5XsVPVoAKroa4CgwFs",
                "2N3kCSytvetmJybdZbqV5wK3Zzekg9SiSe2",
            ],
        ...
        assert_equal(
            attributes[1][str(activation_height)]["v0/params/dfip2203/active"], "false"
        )
