...
class BitcoinHTLCTests(DefiTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].importwallet(
            os.path.join(
                os.path.dirname(os.path.realpath(__file__)), "data/spv_addresses.txt"
            )
        )
        ...
        # Test getpubkey call
        assert_equal(
            self.nodes[0].spv_getaddresspubkey(
                "bcrt1qs2qsynezncmkzef3qsaaumf5r5uvyeh8ykrg37"
            ),
        ...
        try:
            self.nodes[0].spv_createhtlc(
                "0224e7de2f3a9d4cdc4fdc14601c75176287297c212aae9091404956955f1aea",
                "035fb3eadde611a39036e61d4c8288d1b896f2c94cee49e60a3d1c02236f4be490",
                "10",
                seed_hash,
            )
        ...
        htlc_script = self.nodes[0].spv_createhtlc(
            "0224e7de2f3a9d4cdc4fdc14601c75176287297c212aae9091404956955f1aea86",
            "035fb3eadde611a39036e61d4c8288d1b896f2c94cee49e60a3d1c02236f4be490",
            "10",
            seed_hash,
        ...
        assert_equal(
            result["hash"],
            "df95183883789f237977543885e1f82ddc045a3ba90c8f25b43a5b797a35d20e",
        )

        # Try and claim before output present
        try:
            self.nodes[0].spv_claimhtlc(
                "2N1WoHKzHY59uNpXouLQc32h9k5Y3hXK4Ku", address, seed, 1000
            )
        except JSONRPCException as e:
            errorString = e.error["message"]
        ...
        output = self.nodes[0].spv_listhtlcoutputs(
            "2N1WoHKzHY59uNpXouLQc32h9k5Y3hXK4Ku"
        )
        ...
        try:
            self.nodes[0].spv_claimhtlc(
                "2N1WoHKzHY59uNpXouLQc32h9k5Y3hXK4Ku", address, "deadbeef", 1000
            )
        except JSONRPCException as e:
            errorString = e.error["message"]
        ...
        try:
            self.nodes[0].spv_claimhtlc(
                "2NGT3gZvc75NX8DWGqfuEvniHGj5LiY33Ui", address, "deadbeef", 1000
            )
        except JSONRPCException as e:
            errorString = e.error["message"]
        ...
        # seller claim HTLC
        result = self.nodes[0].spv_claimhtlc(
            "2N1WoHKzHY59uNpXouLQc32h9k5Y3hXK4Ku", address, seed, 1000
        )
        assert_equal(result["sendmessage"], "")
        ...
        assert (
            rawtx.find(
                ""
            )
            != -1
        )
        ...
        assert_equal(
            self.nodes[0].spv_gethtlcseed("2N1WoHKzHY59uNpXouLQc32h9k5Y3hXK4Ku"),
        ...
        try:
            self.nodes[0].spv_refundhtlc(
                "2N1WoHKzHY59uNpXouLQc32h9k5Y3hXK4Ku", address, 1000
            )
        except JSONRPCException as e:
            errorString = e.error["message"]
        assert "No unspent HTLC outputs found" in errorString
        ...
        # seller claim HTLC
        result = self.nodes[0].spv_refundhtlc(
            "2N1WoHKzHY59uNpXouLQc32h9k5Y3hXK4Ku", address, 1000
        )
        assert_equal(result["sendmessage"], "")
        ...
        assert (
            rawtx.find(
                "01004c6e63a820df95183883789f237977543885e1f82ddc045a3ba90c8f25b43a5b797a35d20e88210224e7de2f3a9d4cdc4fdc14601c75176287297c212aae9091404956955f1aea86675ab27521035fb3eadde611a39036e61d4c8288d1b896f2c94cee49e60a3d1c02236f4be49068ac"
            )
            != -1
        )
        ...
        # seller claim HTLC
        result = self.nodes[0].spv_claimhtlc(
            htlc_script["address"], address, seed, 1000
        )
        assert_equal(result["sendmessage"], "")
