...
The configuration file is used by `bitcoind`, and `defi-cli`.
...
The configuration file is not automatically created; you can create it using your favorite text editor. By default, the configuration file name is `defi.conf` and it is located in the Bitcoin data directory, but both the Bitcoin data directory and the configuration file path may be changed using the `-datadir` and `-conf` command-line options.
...
-- | -- | --
Windows | `%APPDATA%\Bitcoin\` | `C:\Users\username\AppData\Roaming\DeFi\defi.conf`
