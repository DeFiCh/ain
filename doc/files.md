...
defi.conf        | contains configuration settings for defid
defid.pid        | stores the process id of defid while running
...
debug.log           | contains debug information and general logging generated by defid
