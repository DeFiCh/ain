...
1. Clone the Bitcoin Core source code:
    ```shell
    git clone git@github.com:DeFiCh/ain.git
    cd ain
    ```
...
```shell
mkdir -p "/Users/${USER}/Library/Application Support/DeFi"

touch "/Users/${USER}/Library/Application Support/DeFi/defi.conf"

chmod 600 "/Users/${USER}/Library/Application Support/DeFi/defi.conf"
```
