...
contract ERC20 is Context, IERC20, IERC20Metadata, IDST20Upgradeable {
    ...
    function upgradeToken(
        ...
        bytes memory inputData = abi.encode(msg.sender, address(this), amount);
        bytes memory outputData = new bytes(64);
        bool success;
        ...
        (address newTokenContractAddress, uint256 newAmount) = abi.decode(
            outputData,
            (address, uint256)
        );
