...
# In addition we disable warnings some of which are caused due to the above setup
# and creates too much noise.
# Wno-unused-command-line-argument -Wno-unused-but-set-variable // Wno-unused-variable
